...
- `ATOMIC1_EVIDENCE/py_compile.txt`
- `ATOMIC1_EVIDENCE/unit_test_v7_users_autoswitch_policy.txt`
- `ATOMIC1_EVIDENCE/unit_test_operator_execution_packet.txt`
- `ATOMIC1_EVIDENCE/full_unittest_discover.txt`
- `ATOMIC1_EVIDENCE/git_diff_check.txt`
- `ATOMIC1_EVIDENCE/ba2_drift_forensics_summary.json`
