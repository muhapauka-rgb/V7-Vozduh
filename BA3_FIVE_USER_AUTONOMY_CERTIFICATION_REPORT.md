...
- `BA3_EVIDENCE/phase1_truth_check.json`
- `BA3_EVIDENCE/phase1_convergence_status.json`
- `BA3_EVIDENCE/phase2_truth_after_policy_network.json`
- `BA3_EVIDENCE/phase2_convergence_after_policy_network.json`
...
- `BA3_EVIDENCE/phase2_policy_before.json`
- `BA3_EVIDENCE/phase2_policy_update_patch.json`
- `BA3_EVIDENCE/phase2_policy_update_response.json`
- `BA3_EVIDENCE/phase2_policy_update_summary.json`
- `BA3_EVIDENCE/phase2_policy_after.json`
...
- `BA3_EVIDENCE/phase3_fresh_planner.json`
- `BA3_EVIDENCE/phase3_fresh_planner_summary.json`
...
- `BA3_EVIDENCE/phase4_ba3_packet_generate.json`
- `BA3_EVIDENCE/phase4_ba3_packet.json`
- `BA3_EVIDENCE/phase4_ba3_packet_summary.json`
...
- `BA3_EVIDENCE/phase5_ba3_restore_barrier.json`
...
- `BA3_EVIDENCE/phase6_post_clearance_dry_run.json`
- `BA3_EVIDENCE/phase6_post_clearance_dry_run_summary.json`
...
- `BA3_EVIDENCE/phase7_five_user_apply.json`
- `BA3_EVIDENCE/phase7_drift_blocker_analysis.json`
...
- `BA3_EVIDENCE/phase7_retry1_fresh_planner.json`
- `BA3_EVIDENCE/phase7_retry1_packet.json`
- `BA3_EVIDENCE/phase7_retry1_restore_barrier.json`
- `BA3_EVIDENCE/phase7_retry1_post_clearance_dry_run.json`
- `BA3_EVIDENCE/phase7_retry1_five_user_apply.json`
- `BA3_EVIDENCE/phase7_retry2_fresh_planner.json`
- `BA3_EVIDENCE/phase7_retry2_packet.json`
- `BA3_EVIDENCE/phase7_retry2_restore_barrier.json`
- `BA3_EVIDENCE/phase7_retry2_no_refresh_dry_run.json`
...
- `BA3_EVIDENCE/phase9_exact_candidate_users_registry_after_block.txt`
...
- `BA3_EVIDENCE/phase9_policy_revert_patch.json`
- `BA3_EVIDENCE/phase9_policy_revert_response.json`
- `BA3_EVIDENCE/phase9_policy_revert_summary.json`
- `BA3_EVIDENCE/phase9_policy_after_revert_overview.json`
...
- `BA3_EVIDENCE/phase9_truth_after_block_and_policy_revert.json`
- `BA3_EVIDENCE/phase9_convergence_after_block_and_policy_revert.json`
