...
- `CTR_VERIFY_EVIDENCE/code_reality_map.txt`
...
- `CTR_VERIFY_EVIDENCE/tests_found.txt`
- `CTR_VERIFY_EVIDENCE/targeted_unit_tests.txt`
...
- `CTR_VERIFY_EVIDENCE/fixture_verification.json`
- `CTR_VERIFY_EVIDENCE/fixture_summary.json`
...
- `CTR_VERIFY_EVIDENCE/production_autoswitch_plan_wrapper.json`
- `CTR_VERIFY_EVIDENCE/production_autoswitch_plan.json`
- `CTR_VERIFY_EVIDENCE/production_dry_run_ctr_summary.json`
