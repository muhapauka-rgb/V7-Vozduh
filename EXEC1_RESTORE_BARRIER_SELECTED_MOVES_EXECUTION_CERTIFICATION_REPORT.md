...
- `EXEC1_EVIDENCE/operator_overview_summary.json`
- `EXEC1_EVIDENCE/planner_restore_barrier_code_refs.txt`
- `EXEC1_EVIDENCE/operator_execution_code_refs.txt`
...
- `EXEC1_EVIDENCE/current_switch_decisions.json`
- `EXEC1_EVIDENCE/approved_candidate_moves_before_guard.json`
- `EXEC1_EVIDENCE/autoswitch_plan_summary.json`
...
- `EXEC1_EVIDENCE/counterfactual_summary.json`
...
- `EXEC1_EVIDENCE/execution_readiness_summary.json`
- `EXEC1_EVIDENCE/execution_readiness_raw.json`
...
- `EXEC1_EVIDENCE/fresh_packet_preview_generation_result.json`
- `EXEC1_EVIDENCE/fresh_packet_preview_from_current_plan.json`
