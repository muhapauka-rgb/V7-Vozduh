...
- `program_a1_evidence/phase1_remote_pipeline_refresh.txt`
- `program_a1_evidence/planner_before_after_summary.json`
- `program_a1_evidence/phase2_post_refresh_no_movement_check.txt`
- `program_a1_evidence/a1_remote_pipeline_refresh.sh`
- `program_a1_evidence/a1_post_refresh_no_movement_check.sh`
