...
- `program_a2_evidence/phase1_remote_eligibility_recovery.txt`
- `program_a2_evidence/a2_eligibility_before_after_summary.json`
- `program_a2_evidence/phase2_targeted_quality_probe.txt`
- `program_a2_evidence/a2_final_forensics_summary.json`
- `program_a2_evidence/a2_remote_eligibility_recovery.sh`
- `program_a2_evidence/a2_remote_targeted_quality_probe.sh`
