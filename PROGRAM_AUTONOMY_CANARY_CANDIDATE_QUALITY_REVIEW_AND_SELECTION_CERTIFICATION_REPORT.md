...
- `autonomy_canary_candidate_quality_evidence/production_candidate_quality_review.json`
- `autonomy_canary_candidate_quality_evidence/production_reevaluation_after_deploy.json`
