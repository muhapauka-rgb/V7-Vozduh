...
- `program_a_evidence/duplication_audit.md`
- `program_a_evidence/candidate_packet.md`
- `program_a_evidence/blocker_root_cause.md`
...
Known warning: the working tree still contains the prior documentation-only dirty file `z8_11-evidence/runtime_convergence_snapshot.json`. This is not Program A runtime mutation.
