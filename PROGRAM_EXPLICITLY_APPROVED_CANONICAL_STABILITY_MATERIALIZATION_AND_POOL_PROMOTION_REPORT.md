...
- `explicit_pool_promotion_evidence/pre_materialization_safe_deploy.json`
- `explicit_pool_promotion_evidence/pre_materialization_truth_check_after_deploy.json`
- `explicit_pool_promotion_evidence/pre_materialization_convergence_status_after_deploy.json`
- `explicit_pool_promotion_evidence/pre_materialization_git_ls_remote_updatesystem.txt`
...
- `explicit_pool_promotion_evidence/materialization_api_summary.json`
- `explicit_pool_promotion_evidence/materialization_response_*.json`
...
- `explicit_pool_promotion_evidence/pool_review_after_materialization_before_refresh.json`
...
- `explicit_pool_promotion_evidence/snapshot_refresh_after_materialization.json`
- `explicit_pool_promotion_evidence/planner_dry_run_with_pre_refresh_after_materialization_summary.json`
...
- `explicit_pool_promotion_evidence/pool_review_with_internal_pre_refresh_no_confirm.json`
...
- `explicit_pool_promotion_evidence/pool_promotion_confirmed.json`
...
- `explicit_pool_promotion_evidence/post_promotion_planner_dry_run_summary.json`
- `explicit_pool_promotion_evidence/post_promotion_truth_check.json`
- `explicit_pool_promotion_evidence/post_promotion_convergence_status.json`
- `explicit_pool_promotion_evidence/post_promotion_git_ls_remote_updatesystem.txt`
- `explicit_pool_promotion_evidence/final_summary.json`
