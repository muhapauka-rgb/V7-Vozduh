...
- `perf1_evidence/discovery_inventory.md`
- `perf1_evidence/static_measurement.md`
- `perf1_evidence/runtime_path_map.md`
- `perf1_evidence/intelligence_path_audit.md`
- `perf1_evidence/duplication_audit.md`
- `perf1_evidence/fast_runtime_architecture.md`
- `perf1_evidence/heavy_brain_architecture.md`
- `perf1_evidence/snapshot_architecture.md`
- `perf1_evidence/load_budget_model.md`
- `perf1_evidence/adaptive_testing_model.md`
- `perf1_evidence/log_history_architecture.md`
- `perf1_evidence/performance_risk_analysis.md`
- `perf1_evidence/implementation_roadmap.md`
