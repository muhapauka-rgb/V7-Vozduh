...
- `perf3_evidence/discovery_duplication_audit.md`
- `perf3_evidence/worker_architecture.md`
- `perf3_evidence/snapshot_producer_architecture.md`
- `perf3_evidence/service_score_worker.md`
- `perf3_evidence/trust_worker.md`
- `perf3_evidence/risk_blast_overview_workers.md`
- `perf3_evidence/bounded_execution_rules.md`
- `perf3_evidence/performance_validation.md`
- `perf3_evidence/failure_behavior.md`
- `perf3_evidence/test_results.md`
- `perf3_evidence/updated_load_model.md`
- `perf3_evidence/ri4_recommendation.md`
- `perf3_evidence/safety_scan.md`
