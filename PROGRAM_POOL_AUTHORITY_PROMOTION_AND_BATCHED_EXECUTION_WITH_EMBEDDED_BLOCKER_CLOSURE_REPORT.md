...
- `pool_authority_promotion_batched_execution_evidence/phase1_truth_check.json`
- `pool_authority_promotion_batched_execution_evidence/phase1_convergence_status.json`
...
- `pool_authority_promotion_batched_execution_evidence/final_truth_check.json`
- `pool_authority_promotion_batched_execution_evidence/final_convergence_status.json`
...
- `pool_authority_promotion_batched_execution_evidence/phase2_pool_authority_review_no_confirm.json`
...
- Snapshot refresh: `pool_authority_promotion_batched_execution_evidence/phase2_snapshot_refresh_before_second_large_check.json`
- Second LARGE candidate dry-run: `pool_authority_promotion_batched_execution_evidence/phase2_second_large_candidate_dry_run_max10.json`
- POOL candidate dry-run: `pool_authority_promotion_batched_execution_evidence/phase2_pool_candidate_dry_run_max25.json`
