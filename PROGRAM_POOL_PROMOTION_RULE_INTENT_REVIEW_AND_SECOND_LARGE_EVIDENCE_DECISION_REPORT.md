...
- `pool_promotion_rule_intent_review_evidence/phase4_5_6_7_intent_coverage_equivalence_decision.json`
...
- `pool_promotion_rule_intent_review_evidence/phase3_current_evidence_inventory.json`
