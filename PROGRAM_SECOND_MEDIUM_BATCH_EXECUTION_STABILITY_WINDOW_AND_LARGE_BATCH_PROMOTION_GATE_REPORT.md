...
- `second_medium_large_promotion_evidence/phase1_truth_check.json`
- `second_medium_large_promotion_evidence/phase1_convergence_status.json`
...
- `second_medium_large_promotion_evidence/phase2_fresh_medium_planner_remote.json`
...
- `second_medium_large_promotion_evidence/phase3_packet_generation.json`
- `second_medium_large_promotion_evidence/phase3_five_user_packet.json`
...
- `second_medium_large_promotion_evidence/phase4_packet_recheck_only.json`
- `second_medium_large_promotion_evidence/phase4_restore_barrier_clearance.json`
- `second_medium_large_promotion_evidence/phase4_final_readiness_dry_run.json`
- `second_medium_large_promotion_evidence/phase4_final_readiness_dry_run_no_refresh.json`
...
- `second_medium_large_promotion_evidence/phase_stop_truth_check_after_blocker.json`
- `second_medium_large_promotion_evidence/phase_stop_convergence_after_blocker.json`
