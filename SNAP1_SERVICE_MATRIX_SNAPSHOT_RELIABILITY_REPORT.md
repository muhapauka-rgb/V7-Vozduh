...
- `SNAP1_EVIDENCE/baseline_existing_production_snapshot_gate.json`
- `source1_consistency_evidence/hash_mismatch_root_cause_report.md`
- `SNAP1_EVIDENCE/fix_diff.patch`
...
- `SNAP1_EVIDENCE/py_compile.txt`
- `SNAP1_EVIDENCE/targeted_tests.txt`
- `SNAP1_EVIDENCE/full_unittest.txt`
- `SNAP1_EVIDENCE/git_diff_check.txt`
...
- `SNAP1_EVIDENCE/truth_check_all_after_fix.json`
- `SNAP1_EVIDENCE/convergence_status_after_fix.json`
- `SNAP1_EVIDENCE/git_status_after_fix.txt`
