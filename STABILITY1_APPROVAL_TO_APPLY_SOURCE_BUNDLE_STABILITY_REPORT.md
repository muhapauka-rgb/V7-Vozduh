...
- `STABILITY1_EVIDENCE/source_inventory_and_policy.json`
- `STABILITY1_EVIDENCE/source_owner_code_refs.txt`
...
- `STABILITY1_EVIDENCE/ba2_replay_forensics.json`
...
- `STABILITY1_EVIDENCE/ba3_drift_forensics.json`
...
- `STABILITY1_EVIDENCE/py_compile.txt`
- `STABILITY1_EVIDENCE/unit_test_v7_users_autoswitch_policy.txt`
- `STABILITY1_EVIDENCE/full_unittest_discover.txt`
- `STABILITY1_EVIDENCE/code_diff.patch`
