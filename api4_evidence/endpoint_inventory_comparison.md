...
```bash
python3 tools/v7-admin-endpoint-inventory --admin admin/v7-admin-api --out api4_evidence/before_endpoint_inventory.json
python3 tools/v7-admin-endpoint-inventory --admin admin/v7-admin-api --out api4_evidence/after_endpoint_inventory.json
```
