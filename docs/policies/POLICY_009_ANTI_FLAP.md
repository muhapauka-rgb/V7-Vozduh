...
| Pool max ejection/minimum health. | `PARTIAL` | `ADAPT` | V7 has move limits/capacity gates, not proxy max-ejection semantics. | Planner capacity/load, action-class ladder. | Map to V7-native capacity and blast bounds. | `SMALL_EXTENSION` | Medium high: better pool protection. | `C7` |
