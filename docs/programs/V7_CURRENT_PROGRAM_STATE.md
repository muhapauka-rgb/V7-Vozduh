...
| `PRIMARY_ENGINEERING_FRONTIER` | `RESET-M7` |
| `PRIMARY_ENGINEERING_NEXT_ACTION` | `EXECUTE_RESET_M7_BOUNDED_COHORT_CONSTANT_TIME_AND_WARM_PATH_PROOF` |
...
| `SYSTEM_RESET_INTERNAL_PHASES` | `RESET-M0,RESET-M0B,RESET-M0C,RESET-M1,RESET-M1B,RESET-M2,RESET-M3,RESET-M4,RESET-M5,RESET-M6 COMPLETE; RESET-M7 IN_PROGRESS` |
...
| `CURRENT_STOP_CONDITION` | `RESET_M7_SCALE_AND_WARM_PATH_PROOF_REQUIRED` |
| `CURRENT_ACTIVE_SCOPE` | `SYSTEM_RESET_RESET_M7_BOUNDED_COHORT_CONSTANT_TIME_AND_WARM_PATH_PROOF` |
| `CURRENT_SAFE_NEXT_ACTION` | `Prove the Core class/bucket path across at least 10k users and 50 egresses with generation binding, bounded commit, explicit hard ceiling and no hidden O(N) work; retain legacy fallback.` |
| `CURRENT_SCOPE_CLASS` | `SYSTEM_RESET_AND_ROUTING_CORE_MIGRATION` |
| `CURRENT_STATE_GENERATION` | `cpsgen_RESET_M6_COMPLETE_M7_ACTIVE_20260813T100909Z` |
| `CURRENT_TRANSITION_ID` | `RESET_M6_COMPLETE_TO_RESET_M7_BOUNDED_COHORT_V1` |
| `CURRENT_NEXT_ACTION_ID` | `EXECUTE_RESET_M7_BOUNDED_COHORT_CONSTANT_TIME_AND_WARM_PATH_PROOF` |
| `CURRENT_PROGRAM_STAGE` | `RESET-M7` |
| `CURRENT_PROGRAM_EXECUTION_FRONTIER` | `EXECUTE_RESET_M7_BOUNDED_COHORT_CONSTANT_TIME_AND_WARM_PATH_PROOF` |
...
| `CURRENT_EXECUTION_FRONTIER` | `EXECUTE_RESET_M7_BOUNDED_COHORT_CONSTANT_TIME_AND_WARM_PATH_PROOF` |
...
| `CONTINUATION_DECISION` | `CONTINUE_RESET_M7_ENGINEERING_PROOF` |
| `NEXT_EXECUTABLE_CAPABILITY` | `NONE` |
| `PROGRAM_TERMINAL_STATE` | `RESET_M6_PRODUCTION_PASS_RESET_M7_ACTIVE` |
| `OMP_CONTINUATION_REQUIRED` | `FALSE` |
| `EXTERNAL_INPUT_REQUIRED` | `FALSE` |
| `EXTERNAL_INPUT_TYPE` | `NONE_FOR_RESET_M7_ENGINEERING_PROOF` |
...
| `NEXT_MISSION_ID` | `RESET_M7_BOUNDED_COHORT_CONSTANT_TIME_AND_WARM_PATH_PROOF` |
| `PREMATURE_OPERATOR_RETURN` | `FALSE` |
| `CONTINUATION_ITERATION` | `85` |
| `CONTINUATION_STOP_REASON` | `NONE; RESET-M6 exact Core cutover and verification consumed; RESET-M7 engineering proof is executable` |
