...
State captured: 2026-08-21T16:25:30+03:00
...
Captured: `2026-08-21T16:25:30+03:00`
...
| `CURRENT_SAFE_NEXT_ACTION` | `Use the existing health/profile observation surfaces to prove or safely extend an upstream suspicion producer for REQUIRED_SERVICE_FAILURE, OTHER_PROFILE_REQUIRED_SERVICE_FAILURE, DNS_FAILURE, PARTIAL_CENSORSHIP and MULTI_SERVICE_FAILURE; if none is safe, retain that exact five-class residual and Full fallback.` |
| `CURRENT_SCOPE_CLASS` | `SERVICE_FAILURE_AUTOMATION_EVOLUTION` |
| `CURRENT_STATE_GENERATION` | `cpsgen_SFA_V53_CURRENT_SOURCE_SUSPICION_PRODUCER_2DRAFT` |
| `CURRENT_TRANSITION_ID` | `V5_3_CURRENT_SOURCE_PRODUCER_TUNNEL_COVERED_TO_SERVICE_RESIDUAL_V1` |
...
| `CONTINUATION_ITERATION` | `89` |
| `CONTINUATION_STOP_REASON` | `FAST_SIGNAL_COVERAGE_PARTIAL_CONSUMED; CURRENT_SOURCE_TUNNEL_SUSPICION_PRODUCER_SHADOW_COVERED; FIVE_SERVICE_DNS_CENSORSHIP_MULTI_SERVICE_PRODUCERS_UNPROVEN; PRODUCTION_T0_T11_REMAINS_STOP_SAFE; AUTOMATIC_FAST_REMAINS_HELD` |
...
| `V5_3_FAST_SIGNAL_COVERAGE_TERMINAL` | `FAST_SIGNAL_COVERAGE_PARTIAL` |
| `V5_3_FAST_SIGNAL_COVERAGE_REPORT` | `docs/reports/engineering/2026-08-21_162430_v5_3_current_source_suspicion_producer_partial.md` |
| `V5_3_FAST_SIGNAL_COVERAGE_REPORT_SHA256` | `9914f2b2976007dfbe1b54f207c3a6886a92e4eeb374642f1b43ea68b4a789d9` |
| `V5_3_FAST_SIGNAL_COVERED_CLASSES` | `HARD_CHANNEL_DOWN,INTERFACE_OR_TUNNEL_PROCESS_ABSENT,TUNNEL_UP_INTERNET_DEAD,TELEGRAM_PERSISTENT_FAILURE` |
| `V5_3_FAST_SIGNAL_UNCOVERED_CLASSES` | `REQUIRED_SERVICE_FAILURE,OTHER_PROFILE_REQUIRED_SERVICE_FAILURE,DNS_FAILURE,PARTIAL_CENSORSHIP,MULTI_SERVICE_FAILURE` |
