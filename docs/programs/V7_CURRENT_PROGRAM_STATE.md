...
| `CONTINUATION_STOP_REASON` | `CT_M0F_V_READINESS_PRODUCTION_CALLER_CONSUMED; ENABLED CERTIFICATION IDENTITIES EXIST BUT ONLINE CAPABLE EXACT CERTIFICATION CLIENT AGENT COUNT IS ZERO; EXISTING CONTROLLED_PRODUCTION/CLIENT_AGENT OWNER MUST ACTIVATE OR PROVISION ONE WITH EXPLICIT EXACT-PROBE CAPABILITY BEFORE CONTEXT ISSUANCE` |
...
| `CONSTANT_TIME_COHORT_FAILOVER_STATUS` | CT-M0_CONSUMED; CT-M0F-E_SAFE_ENGINEERING_DEPLOYED_EXACT_PROBE_PRODUCER_AND_CALLER_CONSUMED; CT-M0F-V_FORMED_DEPENDENCY_BLOCKED; CT-M1_FORMED_DEPENDENCY_BLOCKED |
...
| `CT_M0F_DEPLOYED_COMMIT` | 9793f9508127e8f36c28e3a45e67c811b2506ac5 |
