...
| ---: | --- | --- | --- | --- | --- | --- |
| `1` | `FSSE_04_COMPLETE_BACKGROUND_AUTOMATION_PRODUCTION_CERTIFIED` program frontier; `cpsgen_V7_BACKGROUND_AUTOMATION_CERTIFIED_928718904BCD`; `EXTERNAL_REENTRY_TWO_RUN_CERTIFIED_V1` | two distinct natural platform reentries certified the existing external Continue OMP consumer; next scenario NONE | `CONTINUE_OMP` | EXISTING_OMP_SELF_CONTINUATION_CONSUMER | `BOUNDED_INVOCATION_BUDGET_REACHED` | FRESH_CPS -> NEXT_BOUNDED_OMP_ACTION_OR_LEGAL_TERMINAL |
