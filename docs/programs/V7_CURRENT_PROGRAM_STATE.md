...
State captured: 2026-08-21T17:17:00+03:00
...
Captured: `2026-08-21T17:17:00+03:00`
...
| `CURRENT_SAFE_NEXT_ACTION` | `Controlled deploy/revalidation of the existing health-unit producer arguments, followed by fresh Runtime caller/consumer proof and T0-T11 before/after evidence; automatic FAST remains a separate gate.` |
| `CURRENT_SCOPE_CLASS` | `SERVICE_FAILURE_AUTOMATION_EVOLUTION` |
| `CURRENT_STATE_GENERATION` | `cpsgen_SFA_V53_PROFILE_DNS_PRODUCERS_4DRAFT` |
| `CURRENT_TRANSITION_ID` | `V5_3_PROFILE_DNS_PRODUCERS_SHADOW_COVERED_TO_DEPLOY_REVALIDATION_V1` |
...
| `CONTINUATION_STOP_REASON` | `ACTION_RELEVANT_FAST_SIGNAL_COVERAGE_PARTIAL_WITH_EXACT_RESIDUAL_CONSUMED; FIVE_PRODUCER_FAMILIES_SHADOW_IMPLEMENTED; PRODUCTION_DEPLOY_REVALIDATION_AND_T0_T11_PROOF_PENDING; AUTOMATIC_FAST_REMAINS_HELD` |
