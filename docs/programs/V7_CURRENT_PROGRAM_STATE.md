...
State captured: 2026-09-02T20:17:06+00:00
...
Source: The Recovery Stability Foundation remains admitted.  The current governed Apply/verification residual is reconciled as its narrow existing-owner audit subfrontier; only the normal V7 Runtime can produce a recovery action or live acceptance evidence.

## 0. Authoritative Live Current State

Status: `AUTHORITATIVE_LIVE_STATE`

Captured: `2026-09-02T20:17:06+00:00`
...
| `PRIMARY_ENGINEERING_NEXT_ACTION` | `N10_LAWFUL_CURRENT_COHORT_BOUNDARY` |
...
| `SYSTEM_RESET_INTERNAL_PHASES` | `RESET-M0,RESET-M0B,RESET-M0C,RESET-M1,RESET-M1B,RESET-M2,RESET-M3,RESET-M4,RESET-M5,RESET-M6,RESET-M7,RESET-M8,RESET-M9,RESET-M10 COMPLETE` |
...
| `CAUSAL_CONTINUITY_PARENT_GOAL` | `CONTINUE_ACTIVE_INCIDENT_REVALIDATION_AND_DRAIN with the existing CT-M0F CONTROL_PLANE_AND_KERNEL_PATH_CUTOVER SLO subgoal; every internal repair must return to the named parent consumer.` |
...
| `CURRENT_STATE_GENERATION` | `cpsgen_SFA_GOVERNED_APPLY_EE8A48606F01` |
...
| `RECOVERY_STABILITY_CHANGE_CONTAINMENT` | `REQUIRED_PER_RECOVERY_CRITICAL_CHANGE_FINGERPRINT; existing deploy provenance/evidence pointers only; no new registry or Runtime state projection` |
| `RECOVERY_STABILITY_LIVE_ACCEPTANCE` | `RECOVERY_LIVE_ORDINARY_REPEATABILITY_CONSUMED only; certification-only evidence cannot cross-credit ordinary Stability` |
| `RECOVERY_STABILITY_HARDENING_DOCUMENT_VERIFICATION` | `Program/CPS/OMP consistency, focused contract tests and truth-check required before implementation admission; this edit has no Runtime effect` |
| `RECOVERY_LATENCY_SLO_COMPLETION_PRECEDENCE` | `RECOVERY_STABILITY_CONSUMED precedes GLOBAL_ALL_AFFECTED_RECOVERY_SLO_CONSUMED for Program terminal purposes; both and N11_HOT_PATH_RESIDUE_ZERO are required` |
...
| `V5_3_N10_CURRENT_STATUS` | `HISTORICAL_SMALL_COHORT_S11 remains valid. Current block deployed Core-primary admissibility before Authority consumption and mandatory member service/path S11. One new four-member route/Core-primary transition completed but is retained as route-only evidence because S11 was then missing; it is not N10 credit. After the S11 repair, the next fresh exact four-member request drifted to two members at Packet materialization and was denied with users_moved=0. Re-enter only on a new owner-backed exact cohort.` |
...
| `V5_3_N11_CURRENT_STATUS` | `CORE_ROUTE_RESIDUE_CLOSED: broad route checker is the current Core-primary consumer; Core-primary exact verification passes 125/125 memberships and 4/4 classes; one existing-owner closure retired four residual per-user primary rules with users_moved=0. Disabled timer artifacts, append-only ledgers and legacy sync are retained because live installer/recovery/audit or fallback consumers remain; no blind deletion is admitted.` |
...
| `CURRENT_TIME_FORENSICS_REENTRY` | `NONE; receipt perfclose_6e6c4fa62f834a8d4b88da24 and baseline perfclose_1f91af0c6253c6fe75e028c5 are immutable and non-repeatable` |
| `STAGE_48_TIME_GATE` | `PASS_REVALIDATED_RECEIPT_PERFCLOSE_6E6C4FA62F83; READINESS_ONLY_NOT_EXECUTION_AUTHORITY` |
| `STAGE_48_EXECUTION_PERMITTED` | `FALSE` |
...
| `NO_PROGRESS_FINGERPRINT` | `290f10a41c982c0d7b838187571fd63d852bcc0f9811a61db8300dde22b1365b` |
...
| `HEARTBEAT_LAST_WAKEUP_ID` | `hb_e4fa7e090668798413d43486e0ea6a4b` |
| `HEARTBEAT_LAST_EVENT_ID` | `e4fa7e090668798413d43486e0ea6a4be11effab30093c1bc2afff6a0ea8fcc5` |
| `HEARTBEAT_LAST_CPS_GENERATION` | `cpsgen_V7_REENTRY_COMPLETE_E4FA7E090668` |
| `HEARTBEAT_LAST_DEPENDENCY_FINGERPRINT` | `35fb27b2c132c41315d8b6c00216df82bbc2d10f1ee948dfd4a06778ffd023eb` |
| `HEARTBEAT_LAST_DECISION` | `REENTRY_COMPLETED` |
| `HEARTBEAT_LAST_RUN_AT` | `2026-08-01T02:06:42.611418+00:00` |
...
| `LAST_WAKE_REQUEST_ID` | `7068437bd1e11385d7827fbffc1b36dd962285d235be2c0c7648184f8ca68e56` |
| `LAST_DISPATCHED_WAKE_ID` | `NONE` |
| `LAST_CONSUMED_WAKE_ID` | `NONE` |
| `PENDING_WAKE_ID` | `NONE` |
| `WAKE_SOURCE_CPS_GENERATION` | `cpsgen_SFA_V53_DECISION_575602A76448F794` |
| `WAKE_TRANSITION_ID` | `SERVICE_FAILURE_PRODUCT_EVOLUTION_PARALLEL_FRONTIER_ARBITRATION_RECONCILED_V1` |
| `WAKE_REQUESTED_AT` | `2026-08-20T06:42:45+00:00` |
| `WAKE_DISPATCHED_AT` | `NONE` |
| `WAKE_STARTED_AT` | `NONE` |
| `WAKE_COMPLETED_AT` | `NONE` |
| `MEASURED_WAKE_LATENCY_MS` | `252182690` |
| `WRITER_BLOCKING_TIME_MS` | `3571.323` |
| `WATCHDOG_STATE` | `ARMED_PENDING_IMMEDIATE_DISPATCH` |
| `WATCHDOG_FALLBACK_COUNT` | `8` |
| `WATCHDOG_RECOVERY_RESULT` | `PASS` |
| `IMMEDIATE_INVOCATION_COUNT` | `12` |
...
| `REENTRY_LAST_COMPLETED_ID` | `ompre_183f8a02ae77635935740168` |
| `REENTRY_LAST_TRIGGER_ID` | `e4fa7e090668798413d43486e0ea6a4be11effab30093c1bc2afff6a0ea8fcc5` |
| `REENTRY_LAST_TRIGGER_AT` | `2026-08-01T02:06:35.690818+00:00` |
| `REENTRY_LAST_INVOCATION_ID` | `ompre_183f8a02ae77635935740168` |
...
| `PHASE_6_CURRENT_REAL_SITUATION` | `R1_V6 Packet pkt_preview_d2b1e202fa0e65635c1ccb24 reached owner-recorded ROLLBACK_SUCCESS; cleanup PASS; Passport outpass_c981a43ce6f653764caaa3ee is eligible with complete temporal, replay and Learning consumption` |
| `PHASE_6_CURRENT_CANDIDATE` | `NONE` |
| `PHASE_6_CURRENT_PACKET` | `NONE` |
| `PHASE_6_CURRENT_LEASE` | `NONE` |
| `PHASE_6_INTERPRETATION_STATUS` | `SIX_ELIGIBLE_CONTROLLED_PASSPORTS_CERTIFIED; raw log-retention projection remains diagnostic only` |
| `PHASE_6_DECISION_CERTIFICATION_STATUS` | `SIX_COMPLETE_DECISION_TRACE_SNAPSHOT_REPLAY_CHAINS; natural representativeness remains insufficient` |
| `PHASE_6_RUNTIME_ELIGIBILITY` | `R1_V6_CONSUMED_NON_REUSABLE; no production retry admitted; engineering consumer repair and read-only replay only` |
| `PHASE_6_AUTHORITY_STATUS` | `R1_V6_CONSUMED; no retry, approval reuse or Authority expansion; repair deploy remains inside existing engineering owners` |
| `PHASE_6_ROLLBACK_CERTIFICATION` | `ROLLBACK_AND_NO_ROLLBACK_DIVERSITY_COMPLETE; controlled SUCCESS plus v6 ROLLBACK_SUCCESS` |
| `PHASE_6_VERIFICATION_STATUS` | `SIX_ELIGIBLE_CONTROLLED_PASSPORTS_IMMEDIATE_5M_1H_STEADY_STATE_REPLAY_PASS; not class approval` |
| `PHASE_6_OUTCOME_STATUS` | `SIX ELIGIBLE CONTROLLED OUTCOMES; v6 outpass_c981a43ce6f653764caaa3ee adds real ROLLBACK_SUCCESS` |
| `PHASE_6_LEARNING_STATUS` | `v6 learn_d39d80e1fe2eda98c0294914 CONSUMED; M6 remains insufficient only because natural production is absent` |
| `PHASE_6_CAPABILITY_ADVANCEMENT` | `PARTIAL_ADVANCEMENT; rollback/no-rollback diversity closed; CAP-U07 and dependent capabilities retain natural L8 criteria` |
| `PHASE_6_PRODUCTION_MATURITY_DECISION` | `NO_CHANGE; owner value remains 66.9/100 and Production Autonomy remains 0` |
| `PHASE_6_PENDING_EXTERNAL_INPUT` | `QUALIFYING_NATURAL_PRODUCTION_EVENT_ONLY` |
| `PHASE_6_EXACT_STOP` | `REAL_WORLD_LIMIT_NATURAL_LANE_ONLY` |
| `PHASE_6_EXACT_NEXT_ACTION` | `WAIT_FOR_QUALIFYING_NATURAL_PRODUCTION_EVENT_WITH_CAPTURE_READY` |
| `PHASE_6_REENTRY_CONDITIONS` | `qualifying non-synthetic natural production event captured through existing owners` |
...
| `PHASE_6_GLOBAL_STATUS` | `LANES_EXHAUSTED_WAITING_NATURAL_EVIDENCE` |
| `PHASE_6A_SCENARIO_STATUS` | `SCENARIO_FRONTIER_EXHAUSTED_CURRENT_GENERATION; V1-V4 24/24 obligation scenarios certified` |
| `PHASE_6A_SCENARIO_FRONTIER` | `NONE; next-generation discovery found no additional current owner-backed scenario-certifiable obligation` |
| `PHASE_6A_NEXT_SCENARIO_ID` | `NONE` |
| `PHASE_6A_NEXT_ACTION` | `DISCOVER_NEXT_GENERATION_OBLIGATIONS_ON_MATERIAL_CHANGE` |
| `PHASE_6A_EVIDENCE_CLASS` | `ENGINEERING_SCENARIO_EVIDENCE; no natural or maturity credit` |
| `PHASE_6B_CONTROLLED_STATUS` | `CONTROLLED_PRODUCTION_READY_WHERE_SAFE; CERTIFIED_FOR_CLASS_APPROVAL; no current Candidate, Packet or lease` |
| `PHASE_6B_CONTROLLED_FRONTIER` | `NONE_DECLARED_COVERAGE_CELLS_COMPLETE` |
| `PHASE_6B_NEXT_ACTION` | `NONE` |
| `PHASE_6B_AUTHORITY_STATUS` | `R1_V6_ONE_USE_DECISION_CONSUMED_NON_REUSABLE; no production retry or Authority expansion` |
...
| `PHASE_6_GLOBAL_STOP` | `REAL_WORLD_LIMIT_AFTER_SCENARIO_AND_CONTROLLED_CERTIFICATION_EXHAUSTION` |
...
| `SCENARIO_COVERAGE_GENERATION` | `fssef_47d4ea0df4de7cf53c3718c5` |
| `SCENARIO_COVERAGE_FINGERPRINT` | `47d4ea0df4de7cf53c3718c58a9370282e892c8042b6af0446c934026aa245a6` |
...
| `LAST_SCENARIO_FINGERPRINT` | `f5ec55d8ca79f1670e8d9215b411965a876120d869112abee5583e641461f521` |
...
| `CURRENT_EXECUTION_MISSION_ID` | `V7_RECOVERY_APPLY_FRONTIER_RECONCILIATION_AND_CONCURRENCY_PROOF` |
...
| `LATEST_TERMINAL_RUN_NONCE` | `V7_PHASE6_PHASE7_BOUNDARY_20260827_01` |
| `LATEST_TERMINAL_MISSION_STATE` | `COMPREHENSIVE_ENGINEERING_EVOLUTION_ADVANCED_TO_EXACT_AUTHORITY_OR_REALITY_BOUNDARY` |
| `LATEST_TERMINAL_MISSION_REPORT` | `docs/reports/engineering/2026-08-27_phase6_phase7_comprehensive_boundary_consumed.md` |
| `LATEST_TERMINAL_MISSION_STARTED_AT` | `2026-08-27T13:31:40+00:00` |
...
| `CURRENT_MISSION_ID` | `V7_RECOVERY_APPLY_FRONTIER_RECONCILIATION_AND_CONCURRENCY_PROOF` |
| `CURRENT_RUN_NONCE` | `V7_RECOVERY_APPLY_FRONTIER_20260902_01` |
| `CURRENT_MISSION_STATE` | `MISSION_ACTIVE` |
| `CURRENT_MISSION_REPORT` | `docs/reports/engineering/2026-09-02_recovery_apply_frontier_reconciliation_and_concurrency_proof.md` |
...
| `ACTION_CLASS_NON_CONSUMPTION_ROOT_CAUSE` | `PARTIAL; six eligible controlled Passports close rollback/no-rollback diversity; natural_production_present remains the only representative cell` |
...
| `L7_L8_AE_MATERIAL_OUTCOMES` | `SIX ELIGIBLE CONTROLLED PASSPORTS: outpass_1f9c6c5e9f7246388d981052; outpass_5542ff7606b4688f6868d72f; outpass_57779380ae119a2932498de8; outpass_c1fcd2ee3841cf4c5a558d12; outpass_c981a43ce6f653764caaa3ee; outpass_df9caafb1663e8f8677c9a20` |
| `L7_L8_AE_DUPLICATE_DECISION` | `PASS; six eligible material Passports preserve distinct deterministic identities; v6 rollback identity is not a duplicate` |
| `L7_L8_AE_CLOSURE_PROJECTION_STATUS` | `COMPLETE_CONSUMED_FOR_SIX_ELIGIBLE_CONTROLLED_PASSPORTS; activation, immediate/5m/1h/steady-state, feedback, Learning, lease observation and replay bound` |
...
| `L7_L8_AE_M1_RESIDUAL` | `SIX ELIGIBLE CONTROLLED PASSPORTS CONSUMED; prior locked set plus v6 rollback Passport` |
| `L7_L8_AE_M2_RESIDUAL` | `SIX TEMPORALLY COMPLETE; immediate, 5m, 1h and steady-state PASS` |
| `L7_L8_AE_M3_RESIDUAL` | `SIX REPLAY COMPLETE; Decision Trace, bound snapshot, expected/actual terminal and NO_DRIFT PASS` |
| `L7_L8_AE_M4_M8_STATUS` | `M4 CONTROLLED COVERAGE CELLS COMPLETE; M5 CAPTURE READY REAL_WORLD_LIMIT; M6 INSUFFICIENT_EVIDENCE; M7 COMPLETE_CONSUMED_INSUFFICIENT_EVIDENCE; M8 MISSION_NOT_REQUIRED_BY_AUTHORITY_VERDICT` |
| `L7_L8_AE_CURRENT_CYCLE_REPORT` | `docs/reports/engineering/2026-07-25_123800_l7_r1_v6_rollback_diversity_completion_and_l8_boundary.md` |
| `L7_L8_AE_CURRENT_CYCLE_TERMINAL` | `L7_CONTROLLED_ROLLBACK_DIVERSITY_CONSUMED_L8_NATURAL_CAPTURE_READY` |
| `L7_L8_AE_IMMUTABLE_ELIGIBILITY_SET` | `outset_48bda484f8f3ef7985e4716f; eligible passports 6; CONTROLLED_PRODUCTION SUCCESS AND ROLLBACK_SUCCESS` |
...
| `L7_L8_AE_EXACT_MISSING_CELLS` | `natural_production_present` |
| `L7_L8_AE_NEXT_REENTRY` | `WAIT_FOR_QUALIFYING_NATURAL_PRODUCTION_EVENT_WITH_CAPTURE_READY` |
| `L7_L8_AE_FORBIDDEN_EFFECTS` | `PASS; deploy changed exactly three approved owners; replay and delayed consumption were read-only/no-routing; request reuse NONE; Authority expansion NONE; Production Maturity NO_CHANGE_66_9` |
...
| `CERTIFICATION_TRANSACTION_EXECUTED` | `YES_R1_V6_ONE_USER_ROLLBACK_SUCCESS_AND_CLEANUP_COMPLETE` |
...
| `EXACT_REENTRY_TRIGGERS` | `QUALIFYING_NATURAL_PRODUCTION_EVENT` |
| `PRODUCTION_CAPABILITY_FRONTIER` | `NONE` |
| `POLYGON_OBLIGATION_FRONTIER` | `NONE` |
| `POLYGON_MISSION_FRONTIER` | `NONE_NO_INDEPENDENT_SAFE_CRITERION` |
| `L7_L8_PROGRAM_MISSION_FRONTIER` | `EVENT_DRIVEN:L7L8-AE-M5-NATURAL-EVIDENCE-CAPTURE` |
| `ACTIVE_EXECUTION_FRONTIER` | `V7_CONSTANT_TIME_COHORT_FAILOVER_REUSABLE_FAST_PRIMITIVES_CLOSURE_V1; READY_NOT_STARTED` |
| `EXTERNAL_REENTRY_FRONTIER` | `PENDING:7068437bd1e11385d7827fbffc1b36dd962285d235be2c0c7648184f8ca68e56` |
| `PHASE_6_ENGINEERING_STOP` | `NO_EXECUTABLE_ENGINEERING_FRONTIER` |
| `PHASE_6_CONTROLLED_LANE_STOP` | `NONE_DECLARED_COVERAGE_CELLS_COMPLETE` |
| `PHASE_6_NATURAL_LANE_STOP` | `REAL_WORLD_LIMIT` |
| `GLOBAL_ENGINEERING_STOP` | `REAL_WORLD_LIMIT_NATURAL_L8_ONLY` |
| `ENGINEERING_PROGRAM_STATUS` | `L7_CONTROLLED_ROLLBACK_DIVERSITY_CONSUMED_L8_NATURAL_CAPTURE_READY` |
| `ENVIRONMENT_ALIGNMENT_STATUS` | `RUNTIME_ALIGNED_941187a143a2da008f80c8ce8203e4cd8423c21c; deploy-z8-14-Updatesystem-941187a-20260727T001302; exact four-file manifest PASS; production bounded caller STOP_SAFE with apply=false, routing mutation=false, users_moved=0` |
...
| `ACTION_CLASS_ENGINEERING_FRONTIER` | `POLYGON-ACTION-CLASS-CHANNEL_HARD_FAILURE_FAILOVER-ENGINEERING-G1:CONSUMED:CONSUMED; POLYGON-ACTION-CLASS-CORRELATED_PROVIDER_INCIDENT-ENGINEERING-G1:CONSUMED; POLYGON-ACTION-CLASS-RECOVERY_RELAPSE_ANTI_FLAP-ENGINEERING-G1:CONSUMED:CONSUMED; POLYGON-ACTION-CLASS-SERVICE_PLANE_PARTIAL_FAILURE-ENGINEERING-G1:CONSUMED:CONSUMED; POLYGON-ACTION-CLASS-TRANSPORT_PROTOCOL_FAILURE_ATTRIBUTION-ENGINEERING-G1:CONSUMED:CONSUMED` |
...
| `CURRENT_AUTHORITY_REQUEST_ID` | `sdpauth_r1_0e376dd30710b4ed3ea7e804` |
| `CURRENT_AUTHORITY_REQUEST_SCOPE` | `STANDING_POLICY_ACTIVE; existing planner only; fresh Candidate/Packet/lease; max_users=48; max_concurrent_transactions=1; no reuse; all live gates remain required` |
...
| `CURRENT_AUTHORITY_CONTRACT_EXPIRY` | `2026-08-29T16:56:59.965252+00:00` |
| `CURRENT_AUTHORITY_CONTRACT_HASH` | `285af5fc6f4de20415c3e5b1d27a3c2f89d06db5a29af4a60bb88bdf26af2f4f` |
| `CURRENT_AUTHORITY_CONTRACT_ID` | `sdpc_285af5fc6f4de20415c3e5b1` |
| `CURRENT_AUTHORITY_POLICY_SCOPE_HASH` | `23f0f936faa12a90153106f3638c731d2dd4e7990ea4411cf87fdc4bd7cac535` |
...
| `LAST_SERVICE_FAILURE_EXECUTION_FEEDBACK_ID` | `execfb_280dd6712e37aceccbcc5bfb` |
...
| `PRODUCT_EVOLUTION_FRONTIER` | EXECUTE_V7_COMPLETE_HEALTH_TEST_STABILITY_SYSTEM_ATLAS; READY |
| `BOUNDED_COHORT_REUSE_CLASSIFICATION` | `ENGINEERING_QUALIFIED_TO_48_PRODUCTION_ADAPTER_EVIDENCE_SEPARATE` |
| `CAUSAL_M7_TIER_VERDICT` | `EXACT_TIER_48_RUNTIME_AUTHORITY_ACTIVATED` |
...
| `CURRENT_ACTION_CLASS_AUTHORITY_APPROVED_TIER` | `TIER_48_CURRENT_STANDING_POLICY` |
| `CURRENT_ACTION_CLASS_CERTIFIED_TIER` | `TIER_48_ENGINEERING_QUALIFIED; TIER_48_AUTHORITY_ACTIVE; TIER_1_SERVICE_FAILURE_PRODUCTION_PROVEN` |
...
| `CURRENT_ACTION_CLASS_EXACT_NEXT_TIER_RESIDUAL` | `CONTROLLED_SERVICE_FAILURE_CERTIFICATION_PLAN_AND_SAFE_COHORT_REQUIRED; controlled Service Failure adapter outcomes 5->10->25->48; no generic ladder rerun` |
| `CURRENT_ACTION_CLASS_EXPIRY` | `2026-08-29T16:56:59.965252+00:00` |
...
| `CURRENT_ACTION_CLASS_MAX_USERS_PER_TRANSACTION` | `48` |
| `CURRENT_ACTION_CLASS_NEXT_TIER` | `TIER_5_CONTROLLED_SERVICE_FAILURE_ADAPTER_OUTCOME` |
| `CURRENT_ACTION_CLASS_PRODUCTION_PROVEN_TIER` | `TIER_1_CURRENT_CLASS; GENERIC_MOVEMENT_PRODUCTION_EVIDENCE_REUSED_TO_48; SERVICE_FAILURE_CONTROLLED_TIERS_5_10_25_48_PENDING` |
...
| `CURRENT_ACTION_CLASS_TECHNICALLY_IMPLEMENTED_TIER` | `TIER_48_CURRENT_CLASS_ENGINEERING` |
| `CURRENT_ACTION_CLASS_VERIFICATION_CONTRACT` | `EXISTING_LIVE_VERIFICATION_GATES_REQUIRED` |
| `TIER_10_REUSE_CLASSIFICATION` | `ENGINEERING_ADAPTER_QUALIFIED_AUTHORITY_AND_CONTROLLED_OUTCOME_REQUIRED` |
...
| `TIER_5_REUSE_CLASSIFICATION` | `ENGINEERING_ADAPTER_QUALIFIED_AUTHORITY_AND_CONTROLLED_OUTCOME_REQUIRED` |
...
| `CURRENT_ACTION_CLASS_ANTI_FLAP` | `PASS` |
...
| `CURRENT_ACTION_CLASS_ENGINEERING_PROVEN_TIER` | `TIER_48_CURRENT_CLASS_ENGINEERING` |
| `CURRENT_ACTION_CLASS_KNOWLEDGE_FINGERPRINT` | `4dec635532f862c4593a7033a963cbd7236d78cbf29dfedffe77b6c3ccb31a20` |
...
| `CURRENT_VLESS_REENTRY_CONDITION` | `new owner-backed VLESS service incident with non-empty current ordinary route-backed source scope` |
| `CURRENT_VLESS_SCOPE_PROJECTION_OWNER` | `tools/v7-users-autoswitch.service_failure_causal_integrity_status` |
| `CURRENT_VLESS_SCOPE_PROJECTION_STATUS` | `PASS_AUTHORITATIVE_NO_OPEN_CURRENT_VLESS_INCIDENT` |
...
| `PROGRAM_PORTFOLIO_RECONCILIATION_FINGERPRINT` | `d45f49539451b35808fc0d58c7d00a19f3f54b348717a8146a0bd14c45ea0eba` |
...
| `TIER_10_REUSE_MISMATCH_FIELDS` | `Authority_scope,controlled_service_failure_outcome` |
| `TIER_1_REUSE_MISMATCH_FIELDS` | `NONE` |
| `TIER_25_HISTORICAL_REUSE_CLASSIFICATION` | `ENGINEERING_ADAPTER_QUALIFIED_AUTHORITY_AND_CONTROLLED_OUTCOME_REQUIRED` |
| `TIER_25_HISTORICAL_REUSE_MISMATCH_FIELDS` | `Authority_scope,controlled_service_failure_outcome` |
| `TIER_2_REUSE_MISMATCH_FIELDS` | `NONE` |
| `TIER_48_HISTORICAL_REUSE_CLASSIFICATION` | `ENGINEERING_ADAPTER_QUALIFIED_AUTHORITY_AND_CONTROLLED_OUTCOME_REQUIRED` |
| `TIER_48_HISTORICAL_REUSE_MISMATCH_FIELDS` | `Authority_scope,controlled_service_failure_outcome` |
| `TIER_5_REUSE_MISMATCH_FIELDS` | `Authority_scope,controlled_service_failure_outcome` |
...
| `GENERIC_MOVEMENT_NEXT_PRODUCT_EVOLUTION` | `CONTROLLED_SERVICE_FAILURE_CERTIFICATION_PLAN_AND_SAFE_COHORT_REQUIRED; NO_GENERIC_LADDER_RERUN` |
...
| `GENERIC_MOVEMENT_PRIMITIVE_EVIDENCE_FINGERPRINT` | `f56855299403baebc82023700eddfad8b17101def3da3d51425c36405b0c0afe` |
...
| `GENERIC_MOVEMENT_REPLAY_DUPLICATE_SUPPRESSION_PROVEN_MAX` | `4` |
| `GENERIC_MOVEMENT_RESTART_RECOVERY` | `NOT_PROVEN_FOR_COHORT` |
| `GENERIC_MOVEMENT_ROLLBACK_APPLIED_PROVEN_MAX` | `4` |
...
| `SERVICE_FAILURE_ADAPTER_EVIDENCE_FINGERPRINT` | `2d9ac6f6a1f7299efe243adef9eb76b2bd21b0bbea85317f7168153811ae9794` |
| `SERVICE_FAILURE_ADAPTER_EXACT_COMPATIBLE_MAX` | `48` |
| `SERVICE_FAILURE_ADAPTER_GENERIC_COHORT_PATH_MAX` | `48` |
| `SERVICE_FAILURE_ADAPTER_HIGHER_TIER_RESIDUALS` | `controlled_service_failure_adapter_outcomes_5_10_25_48_after_Authority` |
...
| `SERVICE_FAILURE_EFFECTIVE_TIER_FORMULA` | `controlled=min(generic_primitive,exact_adapter,current_Authority,exact controlled-source condition,all-user certification-only classification,live capacity and verification); ordinary=min(generic_primitive,exact_adapter,ordinary proven ceiling,current Authority,live capacity and verification)` |
| `SERVICE_FAILURE_AUTHORITY_APPROVED_MAX` | `48` |
| `SERVICE_FAILURE_CONTROLLED_CERTIFICATION_RUNTIME_MAX` | `48` |
| `SERVICE_FAILURE_ORDINARY_PRODUCTION_RUNTIME_MAX` | `4` |
| `SERVICE_FAILURE_CONTROLLED_PRODUCTION_PROVEN_MAX` | `0` |
| `SERVICE_FAILURE_ORDINARY_PRODUCTION_PROVEN_MAX` | `4` |
| `TIER_4_HISTORICAL_REUSE_CLASSIFICATION` | `ENGINEERING_ADAPTER_QUALIFIED_AUTHORITY_ACTIVE_CONTROLLED_OUTCOME_PENDING` |
| `TIER_4_HISTORICAL_REUSE_MISMATCH_FIELDS` | `NONE` |
| `SERVICE_FAILURE_ADAPTER_TIER_MATRIX` | `[{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"NONE","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_ORDINARY_AND_CONTROLLED","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":1},{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"NONE","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_ORDINARY_AND_CONTROLLED","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":2},{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"NONE","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_ORDINARY_AND_CONTROLLED","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":4},{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"controlled_service_failure_adapter_outcome_tier_5","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_CONTROLLED_ONLY","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":5},{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"controlled_service_failure_adapter_outcome_tier_10","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_CONTROLLED_ONLY","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":10},{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"controlled_service_failure_adapter_outcome_tier_25","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_CONTROLLED_ONLY","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":25},{"authority_status":"ACTIVE","capacity_binding":"PASS_EXISTING_LIVE_PER_TRANSACTION_CAPACITY_GATE","cohort_binding":"PASS_EXACT_IMMUTABLE_PACKET_COHORT","exact_residual":"controlled_service_failure_adapter_outcome_tier_48","generic_execution_reusable":true,"packet_identity":"PASS_ENGINEERING_EXACT_COHORT_PACKET_BINDING","replay_duplicate_suppression":"PASS_ENGINEERING_EXACT_ONCE","restart_recovery":"PASS_CHECKPOINT_AND_DUPLICATE_FORWARD_APPLY_DENIAL","rollback_or_containment":"PASS_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_AND_CIRCUIT_BREAKER","runtime_status":"ACTIVE_CONTROLLED_ONLY","service_verification":"PASS_PER_USER_PLUS_AGGREGATE_TERMINAL","target_compatibility":"PASS_SAME_ASSIGNMENT_AND_ROUTE_SCHEMA","tier":48}]` |
| `CURRENT_TIER_AUTHORITY_REQUESTED_MAX_USERS` | `48` |
| `CURRENT_TIER_AUTHORITY_REQUEST_ACTION_CLASS` | `bounded autonomous controlled certification topology,bounded availability-first controlled failover,channel hard-fail failover` |
| `CURRENT_TIER_AUTHORITY_REQUEST_DECISION_SET` | `APPROVED_CONSUMED` |
| `CURRENT_TIER_AUTHORITY_REQUEST_EXPIRES_AT` | `2026-07-31T08:26:59.966418+00:00` |
| `CURRENT_TIER_AUTHORITY_REQUEST_HASH` | `0e376dd30710b4ed3ea7e804c5a18c6252bc1106d2a7812eae6bd4e3fe460a52` |
| `CURRENT_TIER_AUTHORITY_REQUEST_ID` | `sdpauth_r1_0e376dd30710b4ed3ea7e804` |
| `CURRENT_TIER_AUTHORITY_REQUEST_MAX_CONCURRENT_TRANSACTIONS` | `1` |
| `CURRENT_TIER_AUTHORITY_REQUEST_POLICY_SCOPE_HASH` | `23f0f936faa12a90153106f3638c731d2dd4e7990ea4411cf87fdc4bd7cac535` |
| `CURRENT_TIER_AUTHORITY_REQUEST_STATUS` | `ACTIVATED` |
| `GENERIC_MOVEMENT_ENGINEERING_CERTIFICATION_STATUS` | `ENGINEERING_BOUNDED_COHORT_CONTRACT_PROVEN_TO_TIER_48` |
| `GENERIC_MOVEMENT_ENGINEERING_CERTIFIED_MAX` | `48` |
| `GENERIC_MOVEMENT_ENGINEERING_CERTIFIED_SCOPES` | `1,2,4,5,10,25,48` |
| `GENERIC_MOVEMENT_ENGINEERING_EVIDENCE_CLASS` | `POLYGON_AND_IMPLEMENTATION_CONTRACT` |
| `GENERIC_MOVEMENT_ENGINEERING_IMPLEMENTATION_FINGERPRINTS` | `{"admin_core/operation_scoped_binding.py":"8a341ef6fe9d5602f695a9aedc633b2ea41fe81aabb3cce16cefe7f8cc645ac2","admin_core/operator_execution.py":"00a9a359e1e60664c801ed04f574e67b949ee39e2db3fd641cceac08d4431896","tools/v7-governed-canary-dry-run-cycle":"0d33ffceb7888ead012495a32461066bad3762295fa27143c69d53ee8e7d7dcd","tools/v7-users-autoswitch":"49dfa39f362cbd27df8796fa8ca4ae62ec7c035b12b934545c567607e5b6757a"}` |
| `GENERIC_MOVEMENT_ENGINEERING_PACKET_IDENTITY_MAX` | `48` |
| `GENERIC_MOVEMENT_ENGINEERING_PARTIAL_APPLY_CONTAINMENT_MAX` | `48` |
| `GENERIC_MOVEMENT_ENGINEERING_REPLAY_DUPLICATE_MAX` | `48` |
| `GENERIC_MOVEMENT_ENGINEERING_RESTART_RECOVERY_MAX` | `48` |
| `PROJECT_WIDE_ADAPTER_INHERITANCE` | `[{"adapter_compatible_max":48,"adapter_id":"SERVICE_FAILURE_INCIDENT_DRAIN_ADAPTER","authority_scope":48,"capacity_contract":"live per-transaction target capacity and reserve","exact_residual":"controlled adapter outcomes 5,10,25,48","generic_max_reused":48,"generic_primitive_id":"GENERIC_USER_ROUTE_MOVEMENT_PRIMITIVE","runtime_enabled_scope":48,"scenario_owner":"existing Service Matrix incident and autoswitch owners","scenario_rollback_containment_delta":"bounded checkpoint plus cohort circuit breaker","scenario_verification_delta":"per-user plus aggregate failed-source service verification","source_scope_contract":"failed source plus unresolved incident scope","start_conditions":"fresh incident generation and every live gate","stop_conditions":"source recovery, no safe target, capacity loss, verification or containment failure","target_selection_contract":"fresh existing Planner safe target only"},{"adapter_compatible_max":0,"adapter_id":"CAPACITY_LOAD_REBALANCE_ADAPTER","authority_scope":0,"capacity_contract":"existing load hard-limit and reserve owner","exact_residual":"adapter-specific trigger, verification and Authority qualification","generic_max_reused":48,"generic_primitive_id":"GENERIC_USER_ROUTE_MOVEMENT_PRIMITIVE","runtime_enabled_scope":0,"scenario_owner":"tools/v7-users-autoswitch Planner load and capacity gates","scenario_rollback_containment_delta":"generic contract reusable; adapter trigger delta unqualified","scenario_verification_delta":"selective adapter qualification required","source_scope_contract":"planner-selected imbalance scope","start_conditions":"existing rebalance policy and current load evidence","stop_conditions":"capacity, policy, cooldown, anti-flap or verification gate","target_selection_contract":"existing ranked capacity-safe target"},{"adapter_compatible_max":0,"adapter_id":"PLANNED_MAINTENANCE_MIGRATION_ADAPTER","authority_scope":0,"capacity_contract":"existing live capacity owner required","exact_residual":"adapter-specific intent, consumer and Authority qualification","generic_max_reused":48,"generic_primitive_id":"GENERIC_USER_ROUTE_MOVEMENT_PRIMITIVE","runtime_enabled_scope":0,"scenario_owner":"tools/v7-egress-set-state plus existing governed movement owners","scenario_rollback_containment_delta":"generic contract reusable; maintenance delta unqualified","scenario_verification_delta":"maintenance intent and completion binding required","source_scope_contract":"owner-declared maintenance source","start_conditions":"owner-authorized maintenance intent","stop_conditions":"users remain assigned, no safe target or missing Authority","target_selection_contract":"existing Planner target required"},{"adapter_compatible_max":48,"adapter_id":"MANUAL_GOVERNED_RECOVERY_OR_ROUTE_MIGRATION_ADAPTER","authority_scope":0,"capacity_contract":"execution-time recheck owner","exact_residual":"no reusable standing Authority; scenario remains explicitly governed","generic_max_reused":48,"generic_primitive_id":"GENERIC_USER_ROUTE_MOVEMENT_PRIMITIVE","runtime_enabled_scope":0,"scenario_owner":"existing operator execution Packet and governed-canary owners","scenario_rollback_containment_delta":"historical rollback or certified no-rollback owner","scenario_verification_delta":"historical production evidence owner","source_scope_contract":"exact operator-approved Packet cohort","start_conditions":"fresh exact governed Packet and lease","stop_conditions":"Packet, lease, capacity, verification or Authority mismatch","target_selection_contract":"exact Packet target"}]` |
| `PROJECT_WIDE_ADAPTER_INHERITANCE_STATUS` | `PROJECT_WIDE_ADAPTER_INHERITANCE_BOUND` |
| `CONTROLLED_CERTIFICATION_POOL_ACTIVE_SOURCE_COUNT` | `4` |
| `CONTROLLED_CERTIFICATION_POOL_EXACT_BLOCKER` | `NONE` |
| `CONTROLLED_CERTIFICATION_POOL_FINGERPRINT` | `880f9f34768458b6c80002654b80bbd1a70fa130826ac6cb3b10e78dc8594563` |
| `CONTROLLED_CERTIFICATION_POOL_MAX_USERS_ON_ONE_ACTIVE_SOURCE` | `11` |
| `CONTROLLED_CERTIFICATION_POOL_MISSING_USERS_FOR_TIER_5` | `0` |
| `CONTROLLED_CERTIFICATION_POOL_REENTRY_CONDITION` | `five_or_more_existing_owner_authorized_enabled_certification_users_are_assigned_to_one_active_controlled_source_with_zero_enabled_non_certification_users` |
| `CONTROLLED_CERTIFICATION_POOL_RESPONSIBLE_OWNER` | `existing Controlled Production Certification Program user, registry, assignment and Authority owners` |
| `CONTROLLED_CERTIFICATION_POOL_STATUS` | `CONTROLLED_CERTIFICATION_POOL_READY_FOR_TIER_5` |
| `CONTROLLED_CERTIFICATION_POOL_TOTAL_ENABLED_USERS` | `52` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_REQUEST_ID` | `` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_REQUEST_HASH` | `` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_REQUEST_EXPIRES_AT` | `` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_DECISION_SET` | `APPROVE_CONTROLLED_CERTIFICATION_SUBSTRATE_AND_CAMPAIGN or DECLINE` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_REQUEST_STATUS` | `NONE` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_SUBSCOPES` | `identity provisioning; certification classification/assignment; controlled source condition; progressive 5->10->25->48 campaign; every subscope is explicit and non-transitive` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_AUDIT_OWNER` | `/opt/v7/audit/operator-execution-audit.jsonl; registration=REGISTERED` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_REENTRY` | `exact unexpired request receives one owner-backed APPROVE_CONTROLLED_CERTIFICATION_SUBSTRATE_AND_CAMPAIGN or DECLINE decision; approval permits only the explicitly named existing-owner stages and does not itself provision, assign, degrade or execute` |
| `T48_M8_LEGAL_TERMINAL` | `CONTROLLED_SERVICE_FAILURE_CERTIFICATION_PLAN_AND_SAFE_COHORT_REQUIRED` |
| `T48_M8_STATUS` | `CONTROLLED_CERTIFICATION_POOL_READY_FOR_TIER_5` |
| `SERVICE_FAILURE_CONTEXTUAL_RUNTIME_TIERS` | `CONTROLLED_CERTIFICATION=48; ORDINARY_PRODUCTION=4` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_ACTOR_ID` | `` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_DECISION` | `` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_DECISION_ID` | `` |
| `T48_CONTROLLED_SUBSTRATE_AUTHORITY_SEMANTIC_FINGERPRINT` | `` |
| `AUTOMATIC_REENTRY_CONDITION` | `existing Matrix/registry/quality/capacity generation proves one isolated controlled source has at least 48 current certification identities and all live Stage-48 gates pass; the same owner deterministically recomputes Stage 48 without an operator or Codex message` |
| `CONTROLLED_SOURCE_ROOT_CAUSE_CLASS` | `UNKNOWN` |
| `CURRENT_POOL_AND_CAMPAIGN_STATE` | `campaign identities=52; locations={"amneziawg-exec-20260528-10-8-1-14":5,"awg0":21,"awg3":11,"openvpn-1779388847-d2ad7c":1,"vless":11,"wireguard-1779454504-c43409":3}; controlled production proven max=0; completed stages=NONE; next stage=5` |
| `EXACT_EXTERNAL_OWNER` | `EXTERNAL_EGRESS_PEER_OR_PROFILE_PROVIDER` |
| `EXACT_EXTERNAL_RESOURCE` | `OWNER_VERIFIED_ISOLATED_CONTROLLED_TARGET_OR_CORRELATION_DISTINCT_TARGET_SET_WITH_USABLE_CAPACITY_AT_LEAST_48` |
| `EXACT_REQUIRED_INPUT` | `OWNER_VERIFIED_ISOLATED_CONTROLLED_TARGET_OR_CORRELATION_DISTINCT_TARGET_SET_WITH_USABLE_CAPACITY_AT_LEAST_48` |
| `NEXT_CONSUMER` | `EXISTING_V5_3_PHASE_C_D_E_READ_ONLY_OWNER` |
| `WHY_EXISTING_OWNERS_CANNOT_SUPPLY_IT` | `current drafts have usable capacity 1; current isolated target has usable capacity 8; local V7 owners cannot create a remote peer/profile or expand owner-backed hard capacity` |
| `CONTROLLED_TARGET_FULL_LIVE_ADMISSION` | `STOP_SAFE` |
| `CONTROLLED_TARGET_INVENTORY_FINGERPRINT` | `57a21110ba60c93d81c76f55c4949db9fbfdf054e86361271600a0335b45f1f3` |
| `CONTROLLED_TARGET_SELECTION_STATUS` | `NO_CURRENT_TARGET_CAPACITY_WITH_EXACT_OWNER_BOUNDARY` |
| `CONTROLLED_SOURCE_TOPOLOGY_AUTHORITY_ACTION` | `NONE` |
| `CONTROLLED_SOURCE_TOPOLOGY_AUTHORITY_DECISION` | `APPROVE_PROVISION_DEDICATED_CONTROLLED_CERTIFICATION_SOURCE` |
| `CONTROLLED_SOURCE_TOPOLOGY_AUTHORITY_EXPIRY` | `2026-08-18T21:48:58.287552+00:00` |
| `CONTROLLED_SOURCE_TOPOLOGY_AUTHORITY_STATUS` | `EXPIRED` |
| `CONTROLLED_SOURCE_TOPOLOGY_MANIFEST_HASH` | `ab4e049e2ca638a2acbc609fa194544232863d3fc7d5727c14d4a7fdecd8a832` |
| `CONTROLLED_SOURCE_TOPOLOGY_REQUEST_HASH` | `bdba3fdaeba3e369febc367091fa839c933ec189b6d04c9a04ea0a0a7a9d3a03` |
| `CONTROLLED_SOURCE_TOPOLOGY_REQUEST_ID` | `cstopauth_r1_bdba3fdaeba3e369febc3670` |
| `CONTROLLED_SOURCE_TOPOLOGY_SELECTED_OPTION` | `NONE` |
| `CONTROLLED_SOURCE_TOPOLOGY_SELECTED_RESOURCE` | `NONE` |
| `CONTROLLED_SOURCE_TOPOLOGY_STATUS` | `CONTROLLED_TOPOLOGY_FULL_PATH_EXTERNAL_RESOURCE_REQUIRED` |
...
| `CT_EXACT_CLIENT_RECOVERY_MEASUREMENT_REPORT` | docs/reports/engineering/2026-08-04_165058_exact_client_recovery_measurement_contract_update.md |
| `CT_EXACT_CLIENT_TRAFFIC_PROBE_CONTRACT` | EXACT_CERTIFICATION_IDENTITY_CONTEXT; FRESH_SOCKET; ROUTING_FWMARK_POLICY_BOUND; EXPECTED_TARGET_EGRESS; PAYLOAD_RESPONSE; DNS_FRESH_OR_GENERATION_VALID; NO_MANAGEMENT_ROUTE_OR_COUNTER_SHORTCUT |
| `CT_M0F_SAMPLE_ADMISSION_LAW` | DISTINCT_INDEPENDENTLY_ADMITTED_GENERATION_REQUIRED_BY_ACTIVE_SLO_RESIDUAL; NO_IDENTICAL_REPLAY_AFTER_PROPERTY_PROVEN_WITHOUT_INVALIDATION_OR_NEW_REQUIRED_CONDITION |
| `CT_M0F_SAMPLE_COMPOSITION` | MIN=5; AT_LEAST_ONE_COLD; AT_LEAST_TWO_WARM; REMAINING_TWO_COLD_OR_WARM; AT_LEAST_TWO_OWNER_GENERATIONS |
| `CT_MEASUREMENT_VALIDITY_CONTRACT` | RECORD_CLOCK_DOMAIN_UNCERTAINTY_PROBE_CADENCE_RESOLUTION_TIMEOUT_RETRIES; VERDICT_SENSITIVE_UNCERTAINTY=STOP_SAFE |
...
| `CT_M0F_EXACT_CLIENT_PROBE_STATUS` | EXISTING_CLIENT_TELEMETRY_OWNER_EXTENDED; NATIVE PRODUCER_AND_TIME_CONSUMER_DEPLOYED; COMPACT READINESS OWNER DEPLOYED_AND_PRODUCTION_CALLED; ENABLED_CERTIFICATION_IDENTITIES_PRESENT; ONLINE_CAPABLE_EXACT_CERTIFICATION_CLIENT_CONTEXTS=0; SIMPLE_BROWSER_ONLINE_STATE_IS_NOT_CAPABILITY; VALID EXACT CONTEXT SAMPLE NOT YET ADMITTED; SERVER_HOST_MATRIX_ROUTE_LOOKUP_BROWSER_AND_KERNEL_COUNTER SHORTCUTS REJECTED |
...
| `CT_M0F_VALIDATION_REQUEST_STATUS` | APPROVED_AND_ACTIVE_CONTRACT_REUSED; historical request/decision retained in bounded rotated audit lineage |
...
| `V5_3_PREVIOUS_MODEL_B_PLUS_C_STATUS` | `SELECTED_CORE_WITH_PASSIVE_ESCALATION_MERGED_POST-TOURNAMENT; NOT_RUNTIME_FAST_AUTHORITY` |
| `V5_3_SYSTEM_LEVEL_REVALIDATION_GATE` | `POST_TOURNAMENT_EVIDENCE_CONSUMED; LATENCY_CAUSAL_REVALIDATION_CONSUMED; AUTOMATIC_FAST_REMAINS_HELD` |
| `V5_3_SYSTEM_LEVEL_DECISION` | `TARGET_ARCHITECTURE_MODEL_B_PLUS_C_POST_TOURNAMENT_REVALIDATED` |
...
| `V5_3_LATENCY_CAUSAL_REVALIDATION_TERMINAL` | `B_PLUS_C_LATENCY_CAUSAL_PROOF_PASS` |
| `V5_3_LATENCY_CAUSAL_REVALIDATION_REPORT` | `docs/reports/engineering/2026-08-21_142954_v5_3_stage_e_latency_causal_revalidation.md` |
| `V5_3_LATENCY_CAUSAL_REVALIDATION_REPORT_SHA256` | `2b3d31838ecf151bc5104a5c69b5ca52a058fb40c400bec38ce0fd22940d6fc1` |
| `V5_3_FAST_SIGNAL_COVERAGE_TERMINAL` | `ACTION_RELEVANT_FAST_SIGNAL_COVERAGE_PARTIAL_WITH_EXACT_RESIDUAL` |
| `V5_3_FAST_SIGNAL_COVERAGE_REPORT` | `docs/reports/engineering/2026-08-21_171700_v5_3_profile_service_dns_suspicion_producers_consolidated.md` |
| `V5_3_FAST_SIGNAL_COVERAGE_REPORT_SHA256` | `a176d2b231de2940f8cbfa35ee5986980bcd3ca4fcddb6d7b7c63e9031bf002f` |
| `V5_3_FAST_SIGNAL_COVERED_CLASSES` | `HARD_CHANNEL_DOWN,INTERFACE_OR_TUNNEL_PROCESS_ABSENT,TUNNEL_UP_INTERNET_DEAD,TELEGRAM_PERSISTENT_FAILURE,REQUIRED_SERVICE_FAILURE,OTHER_PROFILE_REQUIRED_SERVICE_FAILURE,DNS_FAILURE,PARTIAL_CENSORSHIP,MULTI_SERVICE_FAILURE` |
| `V5_3_FAST_SIGNAL_UNCOVERED_CLASSES` | `PRODUCTION_FAST_ADMISSION_AND_T0_T11_PROOF_PENDING` |
| `V5_3_FAST_SIGNAL_DEGRADED_NOT_HARD_DOWN_CLASSES` | `LATENCY_LOSS_JITTER_DEGRADATION` |
| `V5_3_FAST_SIGNAL_RECOVERY_ONLY_CLASSES` | `CLEAN_RECOVERY,FAIL_RECOVER_FAIL` |
| `V5_3_FAST_PREDEPLOY_CAUSAL_SCALE_TERMINAL` | `PRE_DEPLOY_FAST_OPTIMIZATION_REQUIRED` |
| `V5_3_FAST_PREDEPLOY_CAUSAL_SCALE_REPORT` | `docs/reports/engineering/2026-08-21_183000_v5_3_fast_producer_scale_and_failure_to_t0_causal_validation.md` |
| `V5_3_FAST_PREDEPLOY_CAUSAL_SCALE_REPORT_SHA256` | `5e3e88b65232a5140eba4d10e5cdba7d3f9629c296d12a887d252c2a54ee014b` |
| `V5_3_FAST_PREDEPLOY_SCOPE` | `ACTIVE_USER_SERVING_SOURCE_PLUS_DISTINCT_EXACT_SERVICE_CONTRACT; NEVER_O_USERS` |
| `V5_3_FAST_PREDEPLOY_POLICY_STATUS` | `OWNER_BACKED_FAILURE_TWO_PRODUCER_SAMPLES_PLUS_TARGETED_MATRIX_CORROBORATION_IS_CONTROLLED_ONLY; CANONICAL_180S_DEFAULT_UNCHANGED; RECOVERY_UNCHANGED` |
| `V5_3_FAST_PREDEPLOY_EXACT_RESIDUAL` | `EXISTING_OWNER_BOUNDED_ACTIVE_COHORT_EXECUTION_DESIGN_AND_POLYGON_TOURNAMENT_7_50_100_1000` |
| `V5_3_FAST_C8_TOURNAMENT_TERMINAL` | `PREDEPLOY_FAST_OPTIMIZATION_REQUIRED_WITH_EXACT_RESIDUAL` |
| `V5_3_FAST_C8_TOURNAMENT_REPORT` | `docs/reports/engineering/2026-08-21_210000_v5_3_bounded_fast_active_cohort_execution_tournament.md` |
...
| `V5_3_STAGE_C_FAILURE_MATRIX_REPORT` | `docs/reports/engineering/2026-08-21_101349_v5_3_stage_c_candidate_failure_matrix_polygon.md` |
| `V5_3_STAGE_D_SCALE_TOURNAMENT_REPORT` | `docs/reports/engineering/2026-08-21_101600_v5_3_stage_d_polygon_scale_tournament.md` |
| `V5_3_POST_TOURNAMENT_ARCHITECTURE_DECISION_REPORT` | `docs/reports/engineering/2026-08-21_102100_v5_3_post_tournament_architecture_decision.md` |
| `V5_3_STAGE_F_BEFORE_AFTER_REPORT` | `docs/reports/engineering/2026-08-21_102900_v5_3_stage_f_before_after_t0_t11_proof.md` |
| `V5_3_STAGE_G_PRODUCTION_BOUNDARY_REPORT` | `docs/reports/engineering/2026-08-21_103000_v5_3_stage_g_production_boundary_and_closure.md` |
...
| `RECOVERY_LATENCY_SLO_CONTRACT` | `T_FIRST_VALID_FAILURE_OBSERVATION -> T_GLOBAL_ALL_AFFECTED_RECOVERED; P95 <= 7000 ms; MAX <= 8000 ms` |
...
| `RECOVERY_STABILITY_EXECUTION_LAW` | `CODEX_REPAIRS_GENERIC_OWNERS_AND_OBSERVES; V7_RUNTIME_ALONE_DETECTS_DECIDES_GOVERNS_APPLIES_AND_VERIFIES` |
...
| `RECOVERY_APPLY_FRONTIER_EXECUTION_LAW` | `CODEX_REPAIRS_GENERIC_EXISTING_OWNERS_AND_OBSERVES; V7_RUNTIME_ALONE_DETECTS_DECIDES_GOVERNS_APPLIES_AND_VERIFIES` |
| `RECOVERY_APPLY_FRONTIER_MISSION` | `V7_RECOVERY_APPLY_FRONTIER_RECONCILIATION_AND_CONCURRENCY_PROOF` |
| `RECOVERY_APPLY_FRONTIER_REPORT` | `docs/reports/engineering/2026-09-02_recovery_apply_frontier_reconciliation_and_concurrency_proof.md` |
| `RECOVERY_APPLY_FRONTIER_REPORT_SHA256` | `ee8a48606f01594dcd30a085ea363492038c91e26850c249bdbb23b17daa0986` |
| `RECOVERY_APPLY_FRONTIER_RUNTIME_EFFECT` | `NONE; normal V7 Runtime remains sole recovery producer` |
...
Generated At: `2026-09-02T20:17:06+00:00`
...
| `CURRENT_STATE_GENERATION` | `cpsgen_SFA_GOVERNED_APPLY_EE8A48606F01` |
| `CURRENT_TRANSITION_ID` | `RECOVERY_APPLY_VERIFICATION_CONCURRENCY_LAW_RECONCILED_V1` |
| `EXACT_CURRENT_SMALLEST_NEXT_ACTION_ID` | `RECOVERY_GOVERNED_APPLY_VERIFICATION_CURRENT_PATH_AUDIT` |
| `CURRENT_STOP_CONDITION` | `NONE` |
...
| `ACTIVE_MISSIONS` | `V7_RECOVERY_APPLY_FRONTIER_RECONCILIATION_AND_CONCURRENCY_PROOF` |
| `LATEST_TERMINAL_MISSION_ID` | `V7_PHASE6_PHASE7_COMPREHENSIVE_AUTONOMOUS_EVOLUTION_CAMPAIGN_V1` |
| `LATEST_TERMINAL_MISSION_STATE` | `COMPREHENSIVE_ENGINEERING_EVOLUTION_ADVANCED_TO_EXACT_AUTHORITY_OR_REALITY_BOUNDARY` |
| `LATEST_TERMINAL_MISSION_REPORT` | `docs/reports/engineering/2026-08-27_phase6_phase7_comprehensive_boundary_consumed.md` |
| `PREVIOUS_TERMINAL_MISSION_ID` | `V7_PHASE6A_OBLIGATION_CORPUS_CONTINUATION_AND_NEXT_GENERATION_V1` |
...
| `EXACT_CURRENT_SMALLEST_NEXT_ACTION` | `RECOVERY_GOVERNED_APPLY_VERIFICATION_CURRENT_PATH_AUDIT` |
...
| `current_state_generation` | `cpsgen_SFA_GOVERNED_APPLY_EE8A48606F01` |
| `current_transition_id` | `RECOVERY_APPLY_VERIFICATION_CONCURRENCY_LAW_RECONCILED_V1` |
| `smallest_existing_next_action_id` | `RECOVERY_GOVERNED_APPLY_VERIFICATION_CURRENT_PATH_AUDIT` |
| `active_mission_id` | `V7_RECOVERY_APPLY_FRONTIER_RECONCILIATION_AND_CONCURRENCY_PROOF` |
| `active_mission_state` | `MISSION_ACTIVE` |
| `latest_terminal_mission_id` | `V7_PHASE6_PHASE7_COMPREHENSIVE_AUTONOMOUS_EVOLUTION_CAMPAIGN_V1` |
| `latest_terminal_mission_state` | `COMPREHENSIVE_ENGINEERING_EVOLUTION_ADVANCED_TO_EXACT_AUTHORITY_OR_REALITY_BOUNDARY` |
| `previous_terminal_mission_id` | `V7_PHASE6A_OBLIGATION_CORPUS_CONTINUATION_AND_NEXT_GENERATION_V1` |
| `authoritative_transition_input_mission_id` | `V7_OMP_BINDING_ATOMIC_SNAPSHOT_AND_MISSION_IDENTITY_GUARD_V3` |
...
| `smallest_existing_next_action` | RECOVERY_GOVERNED_APPLY_VERIFICATION_CURRENT_PATH_AUDIT |
...
| ---: | --- | --- | --- | --- | --- | --- |
| `1` | `RECOVERY_STABILITY_HARDENING` program frontier; `cpsgen_SFA_GOVERNED_APPLY_EE8A48606F01`; `RECOVERY_APPLY_VERIFICATION_CONCURRENCY_LAW_RECONCILED_V1` | U01 Learning chain is consumed; representative real outcomes remain unavailable; next scenario NONE; no independent READY capability exists | `RECOVERY_GOVERNED_APPLY_VERIFICATION_CURRENT_PATH_AUDIT` | existing V5.3 Program, OMP lifecycle, current route/projection owner and Health/Test/Stability owners | `NONE` | fresh input -> OMP reconciliation -> exact owner-backed frontier |
...
| `CAP-U07` | `WAITING_EXTERNAL_DEPENDENCY` | Convert representative real outcomes into reliable future decisions | U01 outcome -> feedback/learning owner -> representative corpus | `CAP-U01` | `CAP-U04,CAP-U08,CAP-U09,CAP-U12,CAP-U17,CAP-U18,CAP-U22` | `CAP-U02,CAP-U05,CAP-U06` | `REAL_WORLD_LIMIT_NATURAL_LANE_ONLY` | qualifying natural production event; six eligible controlled Passports already consume declared L7 coverage | `NO` | `NO` | `ALL_DEPENDENCIES_COMPLETED+INTENT_CLOSED+CONSUMER_VERIFIED+EVIDENCE_CONSUMED+CPS_UPDATED` |
...
| `STAGE_2_ACTIVE_PROGRAM_AT_CLOSURE` | `OMP` |
