...
| `CURRENT_SAFE_NEXT_ACTION` | `Discover an existing Matrix/health caller that can trigger bounded required-service observations for the uncovered failure classes; if none exists, design one minimal shadow-only extension of that existing trigger surface and retain Full fallback.` |
...
| `CONTINUATION_STOP_REASON` | `FAST_SIGNAL_COVERAGE_PARTIAL_CONSUMED; TELEGRAM_OWNER_PATH_COVERED; UNCOVERED_ACTIVE_SERVICE_AND_CHANNEL_CLASSES_REMAIN; PRODUCTION_T0_T11_REMAINS_STOP_SAFE; AUTOMATIC_FAST_REMAINS_HELD` |
...
| `V5_3_FAST_SIGNAL_COVERAGE_REPORT` | `docs/reports/engineering/2026-08-21_144720_v5_3_fast_signal_coverage_owner_backed_partial.md` |
| `V5_3_FAST_SIGNAL_COVERAGE_REPORT_SHA256` | `5eb25edf52920958713af9bb2361d14932bc23f8c7dbadae3bed7d97da43720b` |
| `V5_3_FAST_SIGNAL_COVERED_CLASSES` | `TELEGRAM_PERSISTENT_FAILURE` |
| `V5_3_FAST_SIGNAL_UNCOVERED_CLASSES` | `HARD_CHANNEL_DOWN,INTERFACE_OR_TUNNEL_PROCESS_ABSENT,TUNNEL_UP_INTERNET_DEAD,REQUIRED_SERVICE_FAILURE,OTHER_PROFILE_REQUIRED_SERVICE_FAILURE,DNS_FAILURE,PARTIAL_CENSORSHIP,MULTI_SERVICE_FAILURE,LATENCY_LOSS_JITTER_DEGRADATION,CLEAN_RECOVERY` |
