...
| --- | --- | --- | --- | --- | --- | --- |
| Channels UI | Operator channel inventory, decision-first channel drawer, separated operator/engineer surfaces, compact actionability-first drawer, and final locked operator terminology | `admin/v7-admin-api` | Derived from channel registry, planner assignment truth, service/route/runtime evidence | Channels; Channel Decision V7; Admin UI Operator Model; Channel Operator Signal Model | `UX_4_CHANNEL_DRAWER_REBUILD_SPECIFICATION_REPORT.md`, `CHANNEL_SUITABILITY_2_PLANNER_FIRST_CHANNEL_MODEL_REPORT.md`, `CHANNEL_DECISION_FIRST_1_OPERATOR_SURFACE_REPORT.md`, `CHANNEL_DECISION_FIRST_2_DRAWER_REPORT.md`, `CHANNELS_FINAL_POLISH_AND_LOCK_REPORT.md`, `CHANNELS_FINAL_UX_CLOSE_ONE_PASS_REPORT.md`, `CHANNELS_FINAL_ACTIONABILITY_AND_DENSITY_REPORT.md`, `CHANNELS_OPERATOR_ENGINEER_SEPARATION_REPORT.md` | `0caea169` |
