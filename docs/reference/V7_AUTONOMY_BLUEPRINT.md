...
1. Use `tools/v7-autonomy-trust-evidence-inventory` `outcome_leverage_model` to choose the highest-leverage real outcome activity before assuming governed canary is next.
