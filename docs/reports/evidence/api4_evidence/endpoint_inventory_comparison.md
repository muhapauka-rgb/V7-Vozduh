# API.4 Endpoint Inventory Comparison

## Commands

```bash
python3 tools/v7-admin-endpoint-inventory --admin admin/v7-admin-api --out docs/reports/evidence/api4_evidence/before_endpoint_inventory.json
python3 tools/v7-admin-endpoint-inventory --admin admin/v7-admin-api --out docs/reports/evidence/api4_evidence/after_endpoint_inventory.json
```
