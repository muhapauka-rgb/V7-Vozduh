...
packet = json.loads(Path("docs/reports/evidence/medium_batch_preparation_evidence/phase6_medium_batch_approval_packet.json").read_text())
recheck = json.loads(Path("docs/reports/evidence/medium_batch_preparation_evidence/phase6_packet_recheck_only.json").read_text())
