...
- `docs/reports/evidence/z8_11-evidence/`: documentation only, ignored
- `docs/reports/evidence/z9-evidence/00_mandatory_discovery_gate_no_go.md`: documentation only, ignored
...
```text
env V7_TRUTH_RUNTIME_SNAPSHOT=docs/reports/evidence/z8_11-evidence/runtime_convergence_snapshot.json python3 tools/v7-truth-check --all --json
```
