...
| `docs/reports/evidence/operator_surface_evidence/*`, `docs/reports/evidence/operator_execution_pipeline_evidence/*` | Operator/admin API and workflow evidence. |
