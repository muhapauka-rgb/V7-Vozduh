...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase1_truth_gate.json`
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase1_convergence_gate.json`
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_truth_after_apply.json`
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_convergence_after_apply.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase2_fresh_planner_summary.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase3_packet_generate.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase4_restore_barrier_clearance.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase5_post_clearance_dry_run.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase7_autonomous_apply.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_user_route_registry_10_0_0_2.txt`
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_rollback_packet_generate.json`
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_rollback_dry_run.json`
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_post_execution_snapshot_refresh.json`
...
- `docs/reports/evidence/BA1_CLOSE_EVIDENCE/phase8_feedback_materialization_payload.json`
