...
- `docs/reports/evidence/BA2_EVIDENCE/phase1_truth_gate_escalated.json`
- `docs/reports/evidence/BA2_EVIDENCE/phase1_convergence_gate_escalated.json`
...
- `docs/reports/evidence/BA2_EVIDENCE/phase2_two_user_fresh_planner.json`
- `docs/reports/evidence/BA2_EVIDENCE/phase2_two_user_fresh_planner_summary.json`
- `docs/reports/evidence/BA2_EVIDENCE/phase2_two_user_blocker_analysis.json`
