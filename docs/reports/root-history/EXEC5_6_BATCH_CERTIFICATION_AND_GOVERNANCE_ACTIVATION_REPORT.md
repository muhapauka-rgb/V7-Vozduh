...
- `docs/reports/evidence/EXEC5_6_EVIDENCE/phase1_truth_gate.json`
- `docs/reports/evidence/EXEC5_6_EVIDENCE/phase1_convergence_gate.json`
- `docs/reports/evidence/EXEC5_6_EVIDENCE/phase9_final_truth_check.json`
- `docs/reports/evidence/EXEC5_6_EVIDENCE/phase9_final_convergence_status.json`
