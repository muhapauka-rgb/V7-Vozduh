...
Evidence: `docs/reports/evidence/LOOP1_EVIDENCE/loop1_loop_reality_map.md`.
...
Evidence: `docs/reports/evidence/LOOP1_EVIDENCE/loop1_execution_trace.md`.
...
Evidence: `docs/reports/evidence/LOOP1_EVIDENCE/loop1_automation_gap_audit.md`.
...
Evidence: `docs/reports/evidence/LOOP1_EVIDENCE/loop1_trust_reuse_audit.md`.
...
Evidence: `docs/reports/evidence/LOOP1_EVIDENCE/loop1_no_bypass_review.md`.
