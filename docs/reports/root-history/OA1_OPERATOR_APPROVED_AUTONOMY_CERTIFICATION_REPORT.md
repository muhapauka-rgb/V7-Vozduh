...
Evidence: `docs/reports/evidence/OA1_EVIDENCE/operator_decision_audit.md`.
...
Evidence: `docs/reports/evidence/OA1_EVIDENCE/automation_candidate_audit.md`.
...
Evidence: `docs/reports/evidence/OA1_EVIDENCE/approval_model_required_component.md`.
...
- `docs/reports/evidence/OA1_EVIDENCE/shadow_autonomy_simulation_current.json`
- `docs/reports/evidence/OA1_EVIDENCE/decision_surface_operator_approval_readiness.json`
