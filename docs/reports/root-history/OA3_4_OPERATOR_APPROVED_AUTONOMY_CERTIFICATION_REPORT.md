...
- `docs/reports/evidence/OA3_4_EVIDENCE/local_status.txt`
- `docs/reports/evidence/OA3_4_EVIDENCE/local_diff_name_only.txt`
- `docs/reports/evidence/OA3_4_EVIDENCE/truth_check_all.json`
- `docs/reports/evidence/OA3_4_EVIDENCE/convergence_status.json`
- `docs/reports/evidence/OA3_4_EVIDENCE/oa2_controller_local_presence.txt`
