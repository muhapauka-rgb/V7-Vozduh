...
- `docs/reports/evidence/api2_evidence/before_endpoint_inventory.json`
...
- `docs/reports/evidence/api2_evidence/after_endpoint_inventory.json`
- `docs/reports/evidence/api2_evidence/endpoint_inventory_comparison.md`
