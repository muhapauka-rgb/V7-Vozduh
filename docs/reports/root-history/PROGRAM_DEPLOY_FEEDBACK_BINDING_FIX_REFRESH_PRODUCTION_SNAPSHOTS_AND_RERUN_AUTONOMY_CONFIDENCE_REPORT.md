...
Файл аудита: `docs/reports/evidence/deploy_feedback_binding_fix_audit_evidence/pre_deploy_truth_check.json`, а также `/tmp/deploy_feedback_truth_after.json`.
...
Файл: `docs/reports/evidence/deploy_feedback_binding_fix_audit_evidence/deploy_report.json`
...
Артефакты:
- `docs/reports/evidence/deploy_feedback_binding_fix_audit_evidence/production_snapshot_refresh.json`
...
Файл: `docs/reports/evidence/blast_radius_suitability_evidence_binding_evidence/before_after_trust_evolution_summary.json`
...
- `docs/reports/evidence/deploy_feedback_binding_fix_audit_evidence/autonomy_dry_run.json` (с pre-planner refresh)
