...
- `docs/reports/evidence/large_batch_execution_evidence/phase8_verification_summary.json`
- `docs/reports/evidence/large_batch_stability_pool_readiness_evidence/phase5_feedback_records_for_large_operation.jsonl`
- `docs/reports/evidence/large_batch_stability_pool_readiness_evidence/phase5_feedback_review_summary.json`
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/stability_evidence_reconstruction.json`
...
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/materialization_payload_summary.json`
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/materialization_payloads.json`
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/materialization_payload_*.json`
...
- File: `docs/reports/evidence/large_stability_canonical_feedback_evidence/production_pool_review_before_materialization.json`
- Status: `DENIED`
...
- `PYTHONPYCACHEPREFIX=docs/reports/evidence/large_stability_canonical_feedback_evidence/pycache python3 -m py_compile admin/v7-admin-api admin_core/operator_execution_feedback.py tools/v7-users-autoswitch`
...
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/py_compile.txt`
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/targeted_unittest.txt`
- `docs/reports/evidence/large_stability_canonical_feedback_evidence/full_unittest.txt`
