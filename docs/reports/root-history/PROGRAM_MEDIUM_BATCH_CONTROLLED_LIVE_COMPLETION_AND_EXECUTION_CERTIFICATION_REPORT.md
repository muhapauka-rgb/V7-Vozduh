...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase1_truth_check.json`
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase1_convergence_status.json`
...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase2_fresh_planner.json`
...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase3_packet_generation.json`
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase3_five_user_approval_packet.json`
...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase4_restore_barrier_clearance.json`
...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase5_hash_mismatch_diagnostics.txt`
...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase5_approved_users_current_registry_rows.txt`
...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase5_stop_truth_check.json`
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase5_stop_convergence_status.json`
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase5_stop_convergence_status_retry.json`
