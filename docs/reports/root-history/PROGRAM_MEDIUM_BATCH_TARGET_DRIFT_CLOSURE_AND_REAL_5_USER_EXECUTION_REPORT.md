...
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase2_fresh_planner_remote.json`
- `docs/reports/evidence/medium_batch_controlled_live_evidence/phase5_dry_run_recheck.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt1_snapshot_stop_diagnostics.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt2_snapshot_stop_diagnostics.txt`
...
- `docs/reports/evidence/medium_batch_target_drift_evidence/safe_deploy_snapshot_retry_fix.json`
...
- `docs/reports/evidence/medium_batch_target_drift_evidence/full_unittest_after_snapshot_retry_fix.txt`
...
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt1_fresh_planner.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt1_approval_packet.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt1_restore_barrier_clearance.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt1_dry_run_recheck.json`
...
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt2_fresh_planner.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt2_snapshot_stop_diagnostics.txt`
...
- `docs/reports/evidence/medium_batch_target_drift_evidence/attempt3_fresh_planner.json`
...
- `docs/reports/evidence/medium_batch_target_drift_evidence/final_stop_truth_check.json`
- `docs/reports/evidence/medium_batch_target_drift_evidence/final_stop_convergence_status.json`
