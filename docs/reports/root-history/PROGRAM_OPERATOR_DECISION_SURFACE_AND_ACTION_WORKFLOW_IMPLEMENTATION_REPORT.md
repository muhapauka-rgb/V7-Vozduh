...
- `docs/reports/evidence/operator_surface_evidence/performance_summary.md`
...
- `docs/reports/evidence/operator_surface_evidence/safety_duplication_audit.md`
...
- `docs/reports/evidence/operator_surface_evidence/test_summary.md`
- `docs/reports/evidence/operator_surface_evidence/endpoint_inventory.json`
