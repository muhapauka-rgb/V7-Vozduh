...
- `docs/reports/evidence/perf2_evidence/discovery_and_duplication_audit.md`
- `docs/reports/evidence/perf2_evidence/snapshot_store_architecture.md`
- `docs/reports/evidence/perf2_evidence/snapshot_envelope_and_families.md`
- `docs/reports/evidence/perf2_evidence/freshness_confidence_stop_model.md`
- `docs/reports/evidence/perf2_evidence/runtime_read_contract.md`
- `docs/reports/evidence/perf2_evidence/test_results.md`
- `docs/reports/evidence/perf2_evidence/performance_certification.md`
- `docs/reports/evidence/perf2_evidence/perf3_recommendation.md`
- `docs/reports/evidence/perf2_evidence/safety_scan.md`
