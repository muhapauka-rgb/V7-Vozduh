...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase1_truth_check.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase1_convergence_status.json`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase12_truth_check_after_synthetic.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase12_convergence_status_after_synthetic.json`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase2_users.registry`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase2_best_available_pool.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase2_candidate_suitability_summary.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase2_pool_user_base_audit.json`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase3_pool_capacity_gap_report.json`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_synthetic_user_dry_runs.txt`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_synthetic_user_creation.txt`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_users_before_synthetic.registry`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_users_after_synthetic.registry`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_synthetic_user_creation_summary.json`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_synthetic_route_visibility.txt`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_synthetic_route_visibility_summary.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_snapshot_refresh_after_synthetic.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_planner_dry_run_after_synthetic.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase6_synthetic_user_visibility_summary.json`
...
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase10_pool_capacity_model.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase10_egress_load_after_synthetic.json`
- `docs/reports/evidence/pool_preparation_governance_capacity_evidence/phase10_channel_service_scores_after_synthetic.json`
