...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase1_truth_check_after_alignment.json`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase1_convergence_status_after_alignment.json`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase1_git_ls_remote_after_alignment.txt`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase1_pool_truth_report_summary.json`
...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase2_users.registry`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase2_route_check.txt`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase2_pool_user_review_summary.json`
...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase3_egress.registry`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase3_channel_quality_sources.txt`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase3_pool_channel_review_summary.json`
...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase4_pool_health_review_summary.json`
...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase5_pool_planner_review_summary.json`
...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase6_feedback_records_for_large_operation.jsonl`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase6_pool_feedback_review_summary.json`
...
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase7_rollback_signal_tail.txt`
- `docs/reports/evidence/pool_stability_post_pool_evidence/phase7_pool_rollback_review_summary.json`
