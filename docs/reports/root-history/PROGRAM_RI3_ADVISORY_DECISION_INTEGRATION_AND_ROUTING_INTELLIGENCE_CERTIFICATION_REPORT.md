...
```text
docs/reports/evidence/ri3_evidence/discovery_and_duplication_audit.md
```
...
```text
docs/reports/evidence/ri3_evidence/shadow_replay_summary.md
...
```text
docs/reports/evidence/ri3_evidence/performance_certification.md
```
...
```text
docs/reports/evidence/ri3_evidence/test_results.md
```
