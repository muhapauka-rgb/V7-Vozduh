# E25.8 target-local activation connectivity raw evidence
timestamp_utc=2026-05-28T12:43:50Z
...
default_hash_before=4a75b4e867418b1a91218f8bcfc5127436d4662255c27c5f45eeb8e5965bb324
...
main_route_hash_before=a0232304dfb97a107074161d997f6336969813960d1aeba378b0ee089d24edda
...
## normalized_config
dbc463e711667f2d8d6ed87f191f4b2c17bb5d2eada29e6f363bf6a28de3d3aa  /etc/wireguard/vps.conf
24c15c42b896808a28b78214a515df719be93159cb36f51b8f209add8aa8c522  /etc/wireguard/v7execwg0.conf
[Interface]
PrivateKey = <redacted>
...
dns_present=0
hooks_present=0
address_line=Address = 10.10.0.2/32
...
444: v7execwg0: <POINTOPOINT,NOARP,UP,LOWER_UP> mtu 1280 qdisc noqueue state UNKNOWN mode DEFAULT group default qlen 1000
    link/none 
$ ip addr show v7execwg0
444: v7execwg0: <POINTOPOINT,NOARP,UP,LOWER_UP> mtu 1280 qdisc noqueue state UNKNOWN group default qlen 1000
    link/none 
...
interface: v7execwg0
  ...
  listening port: 49293

peer: LTV4R/fmawlYK70hQKV7q7S6J5XdesH0f4u8oodK3Ro=
  endpoint: <redacted-endpoint>
...
PING 1.1.1.1 (1.1.1.1) from 10.10.0.2 v7execwg0: 200(228) bytes of data.
...
LTV4R/fmawlYK70hQKV7q7S6J5XdesH0f4u8oodK3Ro=	0
$ wg show v7execwg0 transfer
LTV4R/fmawlYK70hQKV7q7S6J5XdesH0f4u8oodK3Ro=	0	592
$ curl --interface v7execwg0 --max-time 10 -sS https://ifconfig.me
curl: (28) Connection timed out after 10002 milliseconds
exit=28
$ wg show v7execwg0 latest-handshakes
LTV4R/fmawlYK70hQKV7q7S6J5XdesH0f4u8oodK3Ro=	0
$ wg show v7execwg0 transfer
LTV4R/fmawlYK70hQKV7q7S6J5XdesH0f4u8oodK3Ro=	0	888

## post_activation_side_effects
