...
class CpsTerminalMissionIdentityRolesTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.latest = "V7_OMP_FUNCTIONAL_FOOTPRINT_AND_REAL_CONSUMER_ACTIVATION_V1"
        cls.previous = "V7_AEP_PHASE_3_INDEPENDENT_ACCEPTANCE_AND_LOCK_V1"
    ...
    def temp_root_with_report(self, first, second):
        ...
        root = Path(tmp.name)
        report = root / "docs/reports/engineering/2026-07-14_172349_omp_functional_footprint_audit.md"
    ...
    def test_09_header_timestamp_predates_latest_start_fails(self):
        drift = self.cps.replace("State captured: 2026-07-14T17:23:49+0700", "State captured: 2026-07-12T02:00:00+0700", 1)
    ...
    def test_12_omp_latest_closure_pointer_mismatch_fails(self):
        drift = self.omp.replace("docs/reports/engineering/2026-07-14_172349_omp_functional_footprint_audit.md", "docs/reports/engineering/stale.md")
