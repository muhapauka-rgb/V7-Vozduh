...
class CpsTerminalMissionIdentityRolesTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.latest = "V7_OMP_FUTURE_SCALE_AUTONOMOUS_POLYGON_INTEGRATION_AND_CERTIFICATION_V1"
        cls.previous = "V7_FUTURE_SCALE_HIGH_FIDELITY_VALIDATION_V1"
    ...
    def temp_root_with_report(self, first, second):
        ...
        root = Path(tmp.name)
        report = root / "docs/reports/engineering/2026-07-15_214500_future_scale_autonomous_polygon_integration_and_certification.md"
    ...
    def test_09_header_timestamp_predates_latest_start_fails(self):
        drift = self.cps.replace("State captured: 2026-07-15T21:45:00+0700", "State captured: 2026-07-12T02:00:00+0700", 1)
    ...
    def test_19_operational_state_is_bounded_at_fsse04_integration(self):
        ...
        self.assertEqual(live["CURRENT_ACTIVE_SCOPE"].strip("`"), "STANDARD_CONTINUE_OMP")
    ...
    def test_21_cap_u01_complete_and_u07_is_sequence_position_one(self):
        ...
        self.assertIn("`FSSE_04_COMPLETE_BOUNDED_CONTINUE_OMP_READY` program frontier", result["sequence_position_1"])
