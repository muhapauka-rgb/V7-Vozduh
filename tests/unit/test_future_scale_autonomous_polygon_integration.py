...
class FutureScaleAutonomousPolygonIntegrationTest(unittest.TestCase):
    ...
    def test_11_unrelated_scenarios_remain_current(self):
        self.assertEqual(len(self.result["selective_invalidation"]["unrelated_scenarios"]), 63)

    def test_12_coverage_transitions_64_63_64(self):
        self.assertEqual((self.result["coverage_before"], self.result["coverage_after_invalidation"], self.result["coverage_after"]), (64, 63, 64))
