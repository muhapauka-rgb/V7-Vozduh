...
class V53RoleBasedRecoveryTest(unittest.TestCase):
    ...
    def test_n3_batch_producer_keeps_two_samples_then_uses_existing_matrix_receiver(self):
        ...
        self.assertRegex(second_state, r"fast_producer_batch_probe_wall_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_setup_wall_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_network_wall_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_owner_elapsed_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_owner_cpu_user_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_owner_cpu_system_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_max_probe_attempt_ms=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_timeout_like_probe_count=\d+")
        self.assertRegex(second_state, r"fast_producer_batch_postprocess_wall_ms=\d+")
